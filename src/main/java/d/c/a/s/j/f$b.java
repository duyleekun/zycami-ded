...
public final class f$b {
    ...
    private int e(int n10, int n11, int n12) {
        ...
        if (n10 == 0 && n11 == (n10 = -2)) {
            String string2 = "CustomViewTarget";
            ...
            return f$b.c(this.a.getContext());
        }
        return 0;
    }
    ...
    public void b() {
        ...
        if (bl2) {
            f$b$a f$b$a = this.d;
            viewTreeObserver.removeOnPreDrawListener((ViewTreeObserver.OnPreDrawListener)f$b$a);
        }
        this.d = null;
        this.b.clear();
    }
