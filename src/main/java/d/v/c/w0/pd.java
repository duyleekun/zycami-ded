...
extends od {
    ...
    static {
        ...
        sparseIntArray.put(2131362814, 1);
    }
    ...
    private pd(DataBindingComponent object, View view, Object[] objectArray) {
        RecyclerView recyclerView = (RecyclerView)objectArray[1];
        super(object, view, 0, recyclerView);
        this.c = -1;
