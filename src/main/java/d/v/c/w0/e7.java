...
extends d7 {
    ...
    private e7(DataBindingComponent dataBindingComponent, View view, Object[] object) {
        object = (RecyclerView)object[0];
        super(dataBindingComponent, view, 0, (RecyclerView)object);
        this.b = -1;
        this.a.setTag(null);
