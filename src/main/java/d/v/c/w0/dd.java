...
extends cd {
    ...
    private dd(DataBindingComponent dataBindingComponent, View view, Object[] object) {
        object = (ZYTextView)object[0];
        super(dataBindingComponent, view, 0, (ZYTextView)object);
        this.b = -1;
        this.a.setTag(null);
