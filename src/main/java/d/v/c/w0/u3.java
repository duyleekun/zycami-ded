...
extends t3 {
    ...
    static {
        ...
        sparseIntArray.put(2131363250, 1);
    }
    ...
    private u3(DataBindingComponent object, View view, Object[] objectArray) {
        StringScrollView stringScrollView = (StringScrollView)objectArray[1];
        super(object, view, 0, stringScrollView);
        this.c = -1;
