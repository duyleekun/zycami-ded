...
implements b$a {
    ...
    private s4(DataBindingComponent dataBindingComponent, View object, Object[] imageButton) {
        int n10 = 1;
        super((Object)dataBindingComponent, (View)object, n10);
        this.h = -1;
        dataBindingComponent = (LinearLayout)imageButton[0];
        this.c = dataBindingComponent;
        dataBindingComponent.setTag(null);
        dataBindingComponent = (ImageButton)imageButton[n10];
    ...
    public void executeBindings() {
        ...
        if (l16 != false) {
            Object object2 = null;
            object = object != null ? ((h2)object).M() : null;
