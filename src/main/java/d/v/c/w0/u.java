...
extends t {
    ...
    private u(DataBindingComponent object, View view, Object[] objectArray) {
        FragmentContainerView fragmentContainerView = (FragmentContainerView)((Object)objectArray[1]);
        super(object, view, 0, fragmentContainerView);
        this.c = -1;
