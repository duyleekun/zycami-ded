...
implements NavDirections {
    ...
    public /* synthetic */ m0$b(m0$a m0$a) {
        this();
    }
    ...
    public boolean equals(Object object) {
        ...
        if (object != null && (serializable = this.getClass()) == (object2 = object.getClass())) {
            ...
            if (n12 != (bl3 = (hashMap = ((m0$b)object).a).containsKey(object2))) {
                return false;
            }
            boolean bl4 = this.a();
            if (bl4 != (bl3 = ((m0$b)object).a())) {
                return false;
            }
            int n11 = this.getActionId();
            if (n11 != (n10 = ((m0$b)object).getActionId())) {
                return false;
            }
            return bl2;
        }
    ...
    public String toString() {
        ...
        stringBuilder.append("ActionMyDeviceFragmentToFirmwareUpgradeFragment(actionId=");
