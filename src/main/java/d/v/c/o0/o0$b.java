...
implements NavDirections {
    ...
    private o0$b(AlbumSection[] object) {
    ...
    public /* synthetic */ o0$b(AlbumSection[] albumSectionArray, o0$a o0$a) {
    ...
    public o0$b b(AlbumSection[] object) {
        if (object != null) {
    ...
    public boolean equals(Object object) {
        ...
        if (object != null && (serializable = this.getClass()) == (object2 = object.getClass())) {
            ...
            if (n12 != (bl4 = (hashMap = ((o0$b)object).a).containsKey(object2))) {
                return false;
            }
            serializable = this.a();
            if (serializable != null ? !(bl3 = (serializable = this.a()).equals(object2 = ((o0$b)object).a())) : (serializable = ((o0$b)object).a()) != null) {
                return false;
            }
            int n11 = this.getActionId();
            if (n11 != (n10 = ((o0$b)object).getActionId())) {
                return false;
            }
            return bl2;
        }
    ...
    public String toString() {
        ...
        stringBuilder.append("ActionAlbumDetailFragmentToAlbumDeleteConfirmDialog(actionId=");
