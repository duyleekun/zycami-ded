...
implements NavDirections {
    ...
    private o2$c(String object, boolean bl2) {
    ...
    public /* synthetic */ o2$c(String string2, boolean bl2, o2$a o2$a) {
        this(string2, bl2);
    }
    ...
    public boolean equals(Object object) {
        ...
        if (object != null && (object3 = this.getClass()) == (object2 = object.getClass())) {
            ...
            if (n12 != (bl4 = (hashMap = ((o2$c)object).a).containsKey(object2))) {
                return false;
            }
            object3 = this.c();
            if (object3 != null ? !(bl3 = ((String)(object3 = this.c())).equals(object2 = ((o2$c)object).c())) : (object3 = ((o2$c)object).c()) != null) {
                return false;
            }
            object3 = this.a;
            object2 = "useBgColor";
            boolean bl5 = ((HashMap)object3).containsKey(object2);
            if (bl5 != (bl4 = (hashMap = ((o2$c)object).a).containsKey(object2))) {
                return false;
            }
            boolean bl6 = this.d();
            if (bl6 != (bl4 = ((o2$c)object).d())) {
                return false;
            }
            object3 = this.a;
            object2 = "hideBack";
            boolean bl7 = ((HashMap)object3).containsKey(object2);
            if (bl7 != (bl4 = (hashMap = ((o2$c)object).a).containsKey(object2))) {
                return false;
            }
            boolean bl8 = this.b();
            if (bl8 != (bl4 = ((o2$c)object).b())) {
                return false;
            }
            object3 = this.a;
            object2 = "darkMode";
            boolean bl9 = ((HashMap)object3).containsKey(object2);
            if (bl9 != (bl4 = (hashMap = ((o2$c)object).a).containsKey(object2))) {
                return false;
            }
            boolean bl10 = this.a();
            if (bl10 != (bl4 = ((o2$c)object).a())) {
                return false;
            }
            int n11 = this.getActionId();
            if (n11 != (n10 = ((o2$c)object).getActionId())) {
                return false;
            }
            return bl2;
        }
    ...
    public String toString() {
        ...
        stringBuilder.append("ActionMainFragmentToWebViewFragment(actionId=");
