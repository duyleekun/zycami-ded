...
implements View.OnClickListener {
    ...
    public /* synthetic */ l(MessageSystemFragment$a messageSystemFragment$a, int n10, MessageSystem messageSystem) {
    ...
    public final void onClick(View view) {
        ...
        messageSystemFragment$a.t(n10, messageSystem, view);
    }
}
