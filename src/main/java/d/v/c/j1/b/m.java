...
implements View.OnClickListener {
    ...
    public /* synthetic */ m(MessageSystemFragment$a messageSystemFragment$a, int n10, MessageSystem messageSystem) {
    ...
    public final void onClick(View view) {
        ...
        messageSystemFragment$a.p(n10, messageSystem, view);
    }
}
