...
implements NavDirections {
    ...
    private k0$b(String object, boolean bl2) {
    ...
    public /* synthetic */ k0$b(String string2, boolean bl2, k0$a k0$a) {
        this(string2, bl2);
    }
    ...
    public boolean equals(Object object) {
        ...
        if (object != null && (object3 = this.getClass()) == (object2 = object.getClass())) {
            ...
            if (n12 != (bl4 = (hashMap = ((k0$b)object).a).containsKey(object2))) {
                return false;
            }
            object3 = this.c();
            if (object3 != null ? !(bl3 = ((String)(object3 = this.c())).equals(object2 = ((k0$b)object).c())) : (object3 = ((k0$b)object).c()) != null) {
                return false;
            }
            object3 = this.a;
            object2 = "useBgColor";
            boolean bl5 = ((HashMap)object3).containsKey(object2);
            if (bl5 != (bl4 = (hashMap = ((k0$b)object).a).containsKey(object2))) {
                return false;
            }
            boolean bl6 = this.d();
            if (bl6 != (bl4 = ((k0$b)object).d())) {
                return false;
            }
            object3 = this.a;
            object2 = "hideBack";
            boolean bl7 = ((HashMap)object3).containsKey(object2);
            if (bl7 != (bl4 = (hashMap = ((k0$b)object).a).containsKey(object2))) {
                return false;
            }
            boolean bl8 = this.b();
            if (bl8 != (bl4 = ((k0$b)object).b())) {
                return false;
            }
            object3 = this.a;
            object2 = "darkMode";
            boolean bl9 = ((HashMap)object3).containsKey(object2);
            if (bl9 != (bl4 = (hashMap = ((k0$b)object).a).containsKey(object2))) {
                return false;
            }
            boolean bl10 = this.a();
            if (bl10 != (bl4 = ((k0$b)object).a())) {
                return false;
            }
            int n11 = this.getActionId();
            if (n11 != (n10 = ((k0$b)object).getActionId())) {
                return false;
            }
            return bl2;
        }
    ...
    public String toString() {
        ...
        stringBuilder.append("ActionMessageLikeFragmentToWebViewFragment(actionId=");
