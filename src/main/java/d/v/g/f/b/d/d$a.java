...
extends EntityInsertionAdapter {
    ...
    public d$a(d d10, RoomDatabase roomDatabase) {
        this.a = d10;
        super(roomDatabase);
    }
    ...
    public String createQuery() {
        return "INSERT OR REPLACE INTO `device_info` (`serial`,`device_name`,`version`,`sub_model`,`create_timestamp`,`update_timestamp`) VALUES (?,?,?,?,?,?)";
    }
}
