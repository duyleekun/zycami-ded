...
extends EntityInsertionAdapter {
    ...
    public f$a(f f10, RoomDatabase roomDatabase) {
        this.a = f10;
        super(roomDatabase);
    }
    ...
    public String createQuery() {
        return "INSERT OR REPLACE INTO `firmware_info` (`_id`,`serial`,`union_version`,`version`,`release_date`,`force_update`,`need_update`,`ota_update`,`notice`,`release_notes`,`before_update_tip`,`after_update_tip`,`md5`,`url`,`path`,`filesize`,`has_popup`) VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)";
    }
}
