...
public class a {
    ...
    public static String a(String object, String object2) {
        ...
        if (!bl2 && !(bl2 = TextUtils.isEmpty((CharSequence)object2))) {
            ...
            try {
                object = d.j.f.a.a.h.d.a.a.b((String)object, (byte[])object2);
                object2 = "UTF-8";
            }
            catch (UnsupportedEncodingException unsupportedEncodingException) {
                g.f(a, "encrypt: UnsupportedEncodingException");
                return string2;
            }
            String string3 = new String((byte[])object, (String)object2);
            return string3;
        }
    ...
    public static byte[] b(String object, byte[] object2) {
        ...
        if (n10 == 0 && object2 != null) {
            ...
            if ((object = d.j.f.a.a.h.d.a.a.c((String)object)) == null) {
            ...
            ((Cipher)object4).init(n12, (Key)object, ivParameterSpec);
            int n13 = ((byte[])object2).length - n11;
            try {
                return ((Cipher)object4).doFinal((byte[])object2, n11, n13);
            }
...
lbl111:
    ...
    public static String d(String object, String object2) {
        ...
        String string2 = d;
        if (bl2) {
            g.f(a, "encrypt: content is null");
            return string2;
        }
        String string3 = "UTF-8";
        try {
            object2 = ((String)object2).getBytes(string3);
        }
        catch (UnsupportedEncodingException unsupportedEncodingException) {
            g.f(a, "encrypt: UnsupportedEncodingException");
            return string2;
        }
        object = d.j.f.a.a.h.d.a.a.e((String)object, (byte[])object2);
    ...
    public static byte[] e(String object, byte[] object2) {
        ...
        if (n10 == 0 && object2 != null) {
            ...
            try {
                ...
                object = d.j.f.a.a.h.d.a.a.c((String)object);
                if (object == null) {
                    object = a;
                ...
                if (byArray2 != null && (n10 = byArray2.length) == (n11 = 16)) {
                    n10 = byArray2.length;
