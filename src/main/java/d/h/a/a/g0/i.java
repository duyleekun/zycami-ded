...
implements Runnable {
    ...
    public /* synthetic */ i(DrmSessionEventListener$EventDispatcher drmSessionEventListener$EventDispatcher, DrmSessionEventListener drmSessionEventListener) {
    ...
    public final void run() {
        ...
        drmSessionEventListener$EventDispatcher.f(drmSessionEventListener);
    }
}
