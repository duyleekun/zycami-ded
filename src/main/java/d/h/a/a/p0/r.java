...
implements ValueAnimator.AnimatorUpdateListener {
    ...
    public /* synthetic */ r(StyledPlayerControlViewLayoutManager styledPlayerControlViewLayoutManager, View view) {
    ...
    public final void onAnimationUpdate(ValueAnimator valueAnimator) {
        ...
        View view = this.b;
        styledPlayerControlViewLayoutManager.j(view, valueAnimator);
    }
}
