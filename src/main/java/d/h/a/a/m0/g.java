...
implements Runnable {
    ...
    public /* synthetic */ g(MediaSourceEventListener$EventDispatcher mediaSourceEventListener$EventDispatcher, MediaSourceEventListener mediaSourceEventListener, LoadEventInfo loadEventInfo, MediaLoadData mediaLoadData) {
    ...
    public final void run() {
        ...
        mediaSourceEventListener$EventDispatcher.j(mediaSourceEventListener, loadEventInfo, mediaLoadData);
    }
}
