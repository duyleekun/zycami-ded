...
implements Runnable {
    ...
    public /* synthetic */ e(MediaSourceEventListener$EventDispatcher mediaSourceEventListener$EventDispatcher, MediaSourceEventListener mediaSourceEventListener, LoadEventInfo loadEventInfo, MediaLoadData mediaLoadData) {
    ...
    public final void run() {
        ...
        mediaSourceEventListener$EventDispatcher.f(mediaSourceEventListener, loadEventInfo, mediaLoadData);
    }
}
