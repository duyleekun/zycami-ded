...
implements ListenerSet$Event {
    ...
    public /* synthetic */ x(AnalyticsListener$EventTime analyticsListener$EventTime, LoadEventInfo loadEventInfo, MediaLoadData mediaLoadData) {
    ...
    public final void invoke(Object object) {
        ...
        AnalyticsCollector.y(analyticsListener$EventTime, loadEventInfo, mediaLoadData, (AnalyticsListener)object);
    }
}
