...
implements ListenerSet$Event {
    ...
    public /* synthetic */ n0(AnalyticsListener$EventTime analyticsListener$EventTime, Format format, DecoderReuseEvaluation decoderReuseEvaluation) {
    ...
    public final void invoke(Object object) {
        ...
        AnalyticsCollector.Z(analyticsListener$EventTime, format, decoderReuseEvaluation, (AnalyticsListener)object);
    }
}
