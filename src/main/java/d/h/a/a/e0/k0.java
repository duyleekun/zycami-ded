...
implements ListenerSet$Event {
    ...
    public /* synthetic */ k0(AnalyticsListener$EventTime analyticsListener$EventTime, LoadEventInfo loadEventInfo, MediaLoadData mediaLoadData) {
    ...
    public final void invoke(Object object) {
        ...
        AnalyticsCollector.x(analyticsListener$EventTime, loadEventInfo, mediaLoadData, (AnalyticsListener)object);
    }
}
