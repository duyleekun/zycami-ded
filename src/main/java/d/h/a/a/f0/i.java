...
implements Runnable {
    ...
    public /* synthetic */ i(AudioRendererEventListener$EventDispatcher audioRendererEventListener$EventDispatcher, DecoderCounters decoderCounters) {
    ...
    public final void run() {
        ...
        audioRendererEventListener$EventDispatcher.j(decoderCounters);
    }
}
