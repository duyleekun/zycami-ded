...
extends n {
    ...
    public n$m(Method method, int n10, h h10, boolean bl2) {
        this.a = method;
        this.b = n10;
        this.c = h10;
        this.d = bl2;
    ...
    public void d(p object, Map object2) {
        ...
        if (object2 != null) {
            ...
            while (bl2 = object2.hasNext()) {
                ...
                if (string2 != null) {
                    ...
                    if (object3 != null) {
                        ...
                        if (charSequence != null) {
                            bl2 = this.d;
                            ((p)object).g(string2, (String)charSequence, bl2);
                            continue;
                        }
                        object = this.a;
                        int n10 = this.b;
                        charSequence = new StringBuilder();
                        ((StringBuilder)charSequence).append("Query map value '");
                    ...
                    ((StringBuilder)object3).append("Query map contained null value for key '");
                ...
                int n12 = this.b;
                objectArray = new Object[]{};
                throw w.o((Method)object, n12, "Query map contained null key.", objectArray);
            }
            return;
        }
        object = this.a;
        int n13 = this.b;
        objectArray = new Object[]{};
        throw w.o((Method)object, n13, "Query map was null", objectArray);
    }
}
