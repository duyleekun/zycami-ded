...
public class GT3GeetestButton$b$a
implements Runnable {
    public final /* synthetic */ GT3GeetestButton$b a;

    public GT3GeetestButton$b$a(GT3GeetestButton$b b10) {
        this.a = b10;
    }

    public void run() {
        GT3GeetestButton.access$500(this.a.a).c();
        GT3GeetestButton.access$500(this.a.a).d();
