...
public class GT3GeetestButton$b$e
implements Runnable {
    public final /* synthetic */ GT3GeetestButton$b a;

    public GT3GeetestButton$b$e(GT3GeetestButton$b gT3GeetestButton$b) {
        this.a = gT3GeetestButton$b;
    }

    public void run() {
        GT3GeetestButton.access$500(this.a.a).h();
        GT3GeetestButton gT3GeetestButton = this.a.a;
        Object object = GT3GeetestButton.access$300(gT3GeetestButton);
        String string2 = "gt3_lin_success_shape";
        ...
        GT3GeetestButton.access$800(this.a.a).setTextColor(-15162286);
        gT3GeetestButton = GT3GeetestButton.access$800(this.a.a);
        n10 = 1065353216;
        float f10 = 1.0f;
        gT3GeetestButton.setAlpha(f10);
        ...
        if (bl2) {
            ...
            string2 = "gt3logogreen";
            n10 = o.d(object, string2);
            gT3GeetestButton.setImageResource(n10);
        }
        GT3GeetestButton.access$1002(this.a.a, true);
        GT3GeetestButton.access$1100(this.a.a).setVisibility(8);
    }
}
