...
public class GT3GeetestButton$b$f
implements Runnable {
    public final /* synthetic */ GT3GeetestButton$b a;

    public GT3GeetestButton$b$f(GT3GeetestButton$b gT3GeetestButton$b) {
        this.a = gT3GeetestButton$b;
    }

    public void run() {
        GT3GeetestButton.access$500(this.a.a).e();
        GT3GeetestButton gT3GeetestButton = this.a.a;
        Object object = GT3GeetestButton.access$300(gT3GeetestButton);
        String string2 = "gt3_lin_click_shape";
