...
Cloneable {
    ...
    static {
        Object object = new jn("XmPushActionCustomConfig");
        a = object;
        a = object = new jf("", 15, 1);
    }

    public int a(ij object) {
        int n10;
        boolean bl2;
        Constable constable;
        ...
        constable2 = this.a();
        n11 = ((Boolean)constable2).compareTo((Boolean)(constable = Boolean.valueOf(bl2 = ((ij)object).a())));
        if (n11 != 0) {
            return n11;
        }
        n11 = (int)(this.a() ? 1 : 0);
        if (n11 != 0 && (n10 = iy.a((List)((Object)(constable2 = this.a)), (List)(object = ((ij)object).a))) != 0) {
            return n10;
        }
        return 0;
    }
    ...
    public void a() {
        ...
        charSequence.append("Required field 'customConfigs' was not present! Struct: ");
     ...
     */
    public boolean a(ij object) {
        if (object == null) {
            return false;
        }
        boolean bl2 = this.a();
        boolean bl3 = ((ij)object).a();
    ...
    public boolean equals(Object object) {
        ...
        boolean bl2 = object instanceof ij;
        if (bl2) {
            object = (ij)object;
            return this.a((ij)object);
        }
