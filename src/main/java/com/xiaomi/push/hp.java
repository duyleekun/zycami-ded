...
Cloneable {
    ...
    static {
        Object object = new jn("ClientUploadData");
        a = object;
    ...
    public int a(hp object) {
        ...
        constable2 = this.a();
        n11 = ((Boolean)constable2).compareTo((Boolean)(constable = Boolean.valueOf(bl2 = ((hp)object).a())));
        if (n11 != 0) {
            return n11;
        }
        n11 = (int)(this.a() ? 1 : 0);
        if (n11 != 0 && (n10 = iy.a((List)((Object)(constable2 = this.a)), (List)(object = ((hp)object).a))) != 0) {
            return n10;
        }
        return 0;
    }
    ...
    public void a() {
        ...
        charSequence.append("Required field 'uploadDataItems' was not present! Struct: ");
     ...
     */
    public boolean a(hp object) {
        if (object == null) {
            return false;
        }
        boolean bl2 = this.a();
        boolean bl3 = ((hp)object).a();
    ...
    public boolean equals(Object object) {
        ...
        boolean bl2 = object instanceof hp;
        if (bl2) {
            object = (hp)object;
            return this.a((hp)object);
        }
