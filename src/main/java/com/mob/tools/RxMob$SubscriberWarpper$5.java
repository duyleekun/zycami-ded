...
public class RxMob$SubscriberWarpper$5
implements Handler.Callback {
    public final /* synthetic */ RxMob$SubscriberWarpper this$0;

    public RxMob$SubscriberWarpper$5(RxMob$SubscriberWarpper rxMob$SubscriberWarpper) {
    ...
    public boolean handleMessage(Message object) {
        ...
        try {
            ...
            String string2 = "[UIThread/onComplete] Network request interrupted as Subscriber is null";
