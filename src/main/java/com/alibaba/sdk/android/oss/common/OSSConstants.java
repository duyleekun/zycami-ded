...
public final class OSSConstants {
    ...
    public static final String[] DEFAULT_CNAME_EXCLUDE_LIST;
    public static final long DEFAULT_FILE_SIZE_LIMIT = 0x140000000L;
    ...
    public static final long MIN_PART_SIZE_LIMIT = 102400L;
    public static final int OBJECT_NAME_MAX_LENGTH = 1024;
    public static final String[] OSS_ORIGN_HOST;
    ...
    static {
        String string2 = "aliyuncs.com";
        String string3 = "aliyun-inc.com";
        String string4 = "aliyun.com";
        DEFAULT_CNAME_EXCLUDE_LIST = new String[]{string2, string3, string4};
        OSS_ORIGN_HOST = new String[]{string2, string3, string4};
    }
}
