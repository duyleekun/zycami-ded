...
extends BaseVoidTask {
    public ProfileTask(String string2, String string3, String string4) {
    ...
    public void doExecute(PushClient pushClient, ResponseErrorCode responseErrorCode, String object, l l10) {
        ...
        Object object2 = "HmsInstanceId";
        if (n10 == 0) {
            HMSLog.i(object2, "ProfileTask success.");
            n10 = 0;
            object = null;
            l10.d(null);
        } else {
            object = new StringBuilder();
            String string2 = "ProfileTask failed, ErrorCode: ";
