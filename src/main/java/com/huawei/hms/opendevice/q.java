...
public final class q {
    ...
    public static void a(Context context, String string2, ResponseErrorCode responseErrorCode) {
    ...
    public static void a(Context context, String string2, String string3, int n10) {
        int n11 = Status.SUCCESS.getStatusCode();
        HiAnalyticsClient.reportExit(context, string2, string3, n11, n10, 50101300);
    }

    public static void a(Context context, String string2, String string3, ErrorEnum errorEnum) {
