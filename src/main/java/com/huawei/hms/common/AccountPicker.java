...
public final class AccountPicker {
    ...
    public static Intent newChooseAccountIntent(Account account, ArrayList arrayList, String[] stringArray, boolean bl2, String string2, String string3, String[] stringArray2, Bundle bundle) {
        ...
        intent.setPackage(HMS_PACKAGE);
        intent.putExtra(EXTRA_ALLOWABLE_ACCOUNTS_ARRAYLIST, (Serializable)arrayList);
        ...
        intent.putExtra(EXTRA_ALWAYS_PROMPT_FOR_ACCOUNT, bl2);
        intent.putExtra(EXTRA_DESCRIPTION_TEXT_OVERRIDE, string2);
        intent.putExtra(EXTRA_ADD_ACCOUNT_AUTH_TOKEN_TYPE_STRING, string3);
