...
public class AlbumCustomizeDao_Impl$3
extends SharedSQLiteStatement {
    public final /* synthetic */ AlbumCustomizeDao_Impl this$0;

    public AlbumCustomizeDao_Impl$3(AlbumCustomizeDao_Impl albumCustomizeDao_Impl, RoomDatabase roomDatabase) {
        this.this$0 = albumCustomizeDao_Impl;
        super(roomDatabase);
    }

    public String createQuery() {
        return "delete from AlbumCustomizeData where albumId = ? and path = ?";
    }
}
