...
public class GoogleBillingClientLifecycle$b
implements f {
    public final /* synthetic */ GoogleBillingClientLifecycle a;

    public GoogleBillingClientLifecycle$b(GoogleBillingClientLifecycle googleBillingClientLifecycle) {
    ...
    public void a(h object) {
        ...
        if (bl2) {
            object = this.a;
            ((GoogleBillingClientLifecycle)object).Y();
        }
    }
