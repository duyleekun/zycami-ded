...
public class GoogleBillingClientLifecycle$c
implements f {
    public final /* synthetic */ GoogleBillingClientLifecycle a;

    public GoogleBillingClientLifecycle$c(GoogleBillingClientLifecycle googleBillingClientLifecycle) {
    ...
    public void a(h object) {
        ...
        if (bl2) {
            object = this.a;
            ((GoogleBillingClientLifecycle)object).W();
        }
    }
