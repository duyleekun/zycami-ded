...
implements Runnable {
    ...
    public DownLoadHelper$5(DownLoadHelper downLoadHelper, String string2, String string3, String string4, DownLoadHelper$OnDownloadCallback downLoadHelper$OnDownloadCallback) {
