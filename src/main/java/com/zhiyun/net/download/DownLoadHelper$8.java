...
implements DownLoadHelper$OnDownloadFileEntityCallback {
    ...
    public DownLoadHelper$8(DownLoadHelper downLoadHelper, List list, DownLoadHelper$OnDownloadFileEntityCallback downLoadHelper$OnDownloadFileEntityCallback, boolean bl2) {
        int n10;
