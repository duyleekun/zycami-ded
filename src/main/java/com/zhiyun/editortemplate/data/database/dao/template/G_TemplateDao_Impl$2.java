...
public class G_TemplateDao_Impl$2
extends EntityInsertionAdapter {
    public final /* synthetic */ G_TemplateDao_Impl this$0;

    public G_TemplateDao_Impl$2(G_TemplateDao_Impl g_TemplateDao_Impl, RoomDatabase roomDatabase) {
    ...
    public String createQuery() {
        return "INSERT OR IGNORE INTO `Template` (`id`,`temp_id`,`type_id`,`reference_id`) VALUES (nullif(?, 0),?,?,?)";
    }
}
