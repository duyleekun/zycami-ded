...
public class G_TemplateStickerDao_Impl$2
extends EntityInsertionAdapter {
    public final /* synthetic */ G_TemplateStickerDao_Impl this$0;

    public G_TemplateStickerDao_Impl$2(G_TemplateStickerDao_Impl g_TemplateStickerDao_Impl, RoomDatabase roomDatabase) {
    ...
    public String createQuery() {
        return "INSERT OR IGNORE INTO `TemplateSticker` (`id`,`temp_id`,`start_time`,`end_time`,`angle`,`center`,`type`,`sticker_type_id`,`scale`,`text_font_size`,`text_color`,`text_content`,`text_caption_name`,`caption_local_source`,`text_font_name`,`image_name`,`gif_name`,`thumb_url`,`local_source`,`customer_uuid`) VALUES (nullif(?, 0),?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)";
    }
}
