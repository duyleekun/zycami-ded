...
public class ScriptTrackMetaDataDao_Impl$1
extends EntityInsertionAdapter {
    public final /* synthetic */ ScriptTrackMetaDataDao_Impl this$0;

    public ScriptTrackMetaDataDao_Impl$1(ScriptTrackMetaDataDao_Impl scriptTrackMetaDataDao_Impl, RoomDatabase roomDatabase) {
    ...
    public String createQuery() {
        return "INSERT OR REPLACE INTO `script_metadata` (`id`,`track_metadata_id`,`product`,`name`,`version`) VALUES (nullif(?, 0),?,?,?,?)";
    }
}
