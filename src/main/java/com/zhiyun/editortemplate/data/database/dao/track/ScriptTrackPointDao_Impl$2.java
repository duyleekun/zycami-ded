...
public class ScriptTrackPointDao_Impl$2
extends EntityInsertionAdapter {
    public final /* synthetic */ ScriptTrackPointDao_Impl this$0;

    public ScriptTrackPointDao_Impl$2(ScriptTrackPointDao_Impl scriptTrackPointDao_Impl, RoomDatabase roomDatabase) {
    ...
    public String createQuery() {
        return "INSERT OR IGNORE INTO `script_track_point` (`id`,`track_point_id`,`type`,`duration`,`yaw`,`pitch`,`roll`,`orientation`,`func`,`zoom_start`,`zoom_end`,`zoom_type`,`focus_start`,`focus_end`,`focus_type`) VALUES (nullif(?, 0),?,?,?,?,?,?,?,?,?,?,?,?,?,?)";
    }
}
