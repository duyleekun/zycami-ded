...
public class G_TemplateMusicDao_Impl$1
extends EntityInsertionAdapter {
    public final /* synthetic */ G_TemplateMusicDao_Impl this$0;

    public G_TemplateMusicDao_Impl$1(G_TemplateMusicDao_Impl g_TemplateMusicDao_Impl, RoomDatabase roomDatabase) {
    ...
    public String createQuery() {
        return "INSERT OR REPLACE INTO `TemplateMusic` (`id`,`temp_id`,`name`,`title`,`attach_time`,`start_time`,`end_time`,`timebase`,`volume`,`mute`,`local_source`,`customer_uuid`,`fade_in_start_time`,`fade_in_end_time`,`fade_in_start_volume`,`fade_in_end_volume`,`fade_out_start_time`,`fade_out_end_time`,`fade_out_start_volume`,`fade_out_end_volume`) VALUES (nullif(?, 0),?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)";
    }
}
