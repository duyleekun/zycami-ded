...
public class G_TemplateDao_Impl$4
extends EntityDeletionOrUpdateAdapter {
    public final /* synthetic */ G_TemplateDao_Impl this$0;

    public G_TemplateDao_Impl$4(G_TemplateDao_Impl g_TemplateDao_Impl, RoomDatabase roomDatabase) {
    ...
    public String createQuery() {
        return "UPDATE OR REPLACE `Template` SET `id` = ?,`temp_id` = ?,`type_id` = ?,`reference_id` = ? WHERE `id` = ?";
    }
}
