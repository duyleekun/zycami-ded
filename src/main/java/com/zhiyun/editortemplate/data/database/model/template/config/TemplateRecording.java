...
public class TemplateRecording
extends TemplateAudioData {
    public TemplateRecording() {
    }

    public TemplateRecording(long l10, long l11, String string2, String string3, long l12, long l13, long l14, long l15, float f10, boolean bl2, boolean bl3, TemplateAudioTransition templateAudioTransition, TemplateAudioTransition templateAudioTransition2) {
        super(l10, l11, string2, string3, l12, l13, l14, l15, f10, bl2, bl3, templateAudioTransition, templateAudioTransition2);
    }

    public TemplateRecording(String string2, String string3, long l10, long l11, long l12, long l13, float f10, boolean bl2, boolean bl3, TemplateAudioTransition templateAudioTransition, TemplateAudioTransition templateAudioTransition2) {
        super(string2, string3, l10, l11, l12, l13, f10, bl2, bl3, templateAudioTransition, templateAudioTransition2);
    }

    public TemplateRecording clone() {
        Object object;
        ...
        object3 = object;
        TemplateRecording templateRecording = object;
        object = object4;
        ((TemplateRecording)object3)((String)object2, string2, l10, l11, l12, l13, f10, bl2, bl3, templateAudioTransition, (TemplateAudioTransition)object4);
        object3 = this.getCustomerUUID();
        object2 = templateRecording;
        templateRecording.setCustomerUUID((String)object3);
