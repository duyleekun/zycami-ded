...
public class G_DraftDao_Impl$2
extends EntityInsertionAdapter {
    public final /* synthetic */ G_DraftDao_Impl this$0;

    public G_DraftDao_Impl$2(G_DraftDao_Impl g_DraftDao_Impl, RoomDatabase roomDatabase) {
    ...
    public String createQuery() {
        return "INSERT OR IGNORE INTO `draft` (`id`,`draft_id`,`create_time`,`content_desc`) VALUES (nullif(?, 0),?,?,?)";
    }
}
