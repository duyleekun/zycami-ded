...
public class G_ScriptDao_Impl$1
extends EntityInsertionAdapter {
    public final /* synthetic */ G_ScriptDao_Impl this$0;

    public G_ScriptDao_Impl$1(G_ScriptDao_Impl g_ScriptDao_Impl, RoomDatabase roomDatabase) {
    ...
    public String createQuery() {
        return "INSERT OR REPLACE INTO `script` (`id`,`script_id`,`reference_id`) VALUES (nullif(?, 0),?,?)";
    }
}
