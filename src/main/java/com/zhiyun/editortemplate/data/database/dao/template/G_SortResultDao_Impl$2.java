...
public class G_SortResultDao_Impl$2
extends EntityInsertionAdapter {
    public final /* synthetic */ G_SortResultDao_Impl this$0;

    public G_SortResultDao_Impl$2(G_SortResultDao_Impl g_SortResultDao_Impl, RoomDatabase roomDatabase) {
    ...
    public String createQuery() {
        return "INSERT OR IGNORE INTO `SortResult` (`page_type`,`next_page`,`count`,`id_list`) VALUES (?,?,?,?)";
    }
}
