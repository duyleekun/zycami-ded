...
public class G_WithdrawDao_Impl$4
extends EntityDeletionOrUpdateAdapter {
    public final /* synthetic */ G_WithdrawDao_Impl this$0;

    public G_WithdrawDao_Impl$4(G_WithdrawDao_Impl g_WithdrawDao_Impl, RoomDatabase roomDatabase) {
    ...
    public String createQuery() {
        return "UPDATE OR REPLACE `withdraw` SET `id` = ?,`back_id` = ?,`create_time` = ? WHERE `id` = ?";
    }
}
