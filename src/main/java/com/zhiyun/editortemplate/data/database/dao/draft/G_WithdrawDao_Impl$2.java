...
public class G_WithdrawDao_Impl$2
extends EntityInsertionAdapter {
    public final /* synthetic */ G_WithdrawDao_Impl this$0;

    public G_WithdrawDao_Impl$2(G_WithdrawDao_Impl g_WithdrawDao_Impl, RoomDatabase roomDatabase) {
    ...
    public String createQuery() {
        return "INSERT OR IGNORE INTO `withdraw` (`id`,`back_id`,`create_time`) VALUES (nullif(?, 0),?,?)";
    }
}
