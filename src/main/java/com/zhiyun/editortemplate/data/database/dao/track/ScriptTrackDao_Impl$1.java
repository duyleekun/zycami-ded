...
public class ScriptTrackDao_Impl$1
extends EntityInsertionAdapter {
    public final /* synthetic */ ScriptTrackDao_Impl this$0;

    public ScriptTrackDao_Impl$1(ScriptTrackDao_Impl scriptTrackDao_Impl, RoomDatabase roomDatabase) {
    ...
    public String createQuery() {
        return "INSERT OR REPLACE INTO `script_track` (`id`,`script_track_id`,`track_id`,`duration_type`) VALUES (nullif(?, 0),?,?,?)";
    }
}
