...
public class FilterDataDao_Impl$8
extends SharedSQLiteStatement {
    public final /* synthetic */ FilterDataDao_Impl this$0;

    public FilterDataDao_Impl$8(FilterDataDao_Impl filterDataDao_Impl, RoomDatabase roomDatabase) {
        this.this$0 = filterDataDao_Impl;
        super(roomDatabase);
    }

    public String createQuery() {
        return "UPDATE filter_data SET thumb = ? WHERE hash = ?";
    }
}
