...
public class FilterFileDao_Impl$2
extends EntityInsertionAdapter {
    public final /* synthetic */ FilterFileDao_Impl this$0;

    public FilterFileDao_Impl$2(FilterFileDao_Impl filterFileDao_Impl, RoomDatabase roomDatabase) {
    ...
    public String createQuery() {
        return "INSERT OR IGNORE INTO `filter_file` (`hash`,`name`,`category`,`mime`,`size`,`url`,`path`,`download_timestamp`,`ext_lic_url`,`ext_lic_name`,`ext_lic_path`) VALUES (?,?,?,?,?,?,?,?,?,?,?)";
    }
}
