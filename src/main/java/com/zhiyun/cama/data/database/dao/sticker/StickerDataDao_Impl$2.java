...
public class StickerDataDao_Impl$2
extends EntityInsertionAdapter {
    public final /* synthetic */ StickerDataDao_Impl this$0;

    public StickerDataDao_Impl$2(StickerDataDao_Impl stickerDataDao_Impl, RoomDatabase roomDatabase) {
    ...
    public String createQuery() {
        return "INSERT OR IGNORE INTO `sticker_data` (`type_id`,`size`,`name`,`scale`,`thumb`,`little_thumb`,`path`,`hash`,`licensePath`,`licenseName`,`requiredPrime`,`id`,`res_id`,`label`,`label_tw`,`label_en`,`sort`) VALUES (?,?,?,?,?,?,?,?,?,?,?,nullif(?, 0),?,?,?,?,?)";
    }
}
