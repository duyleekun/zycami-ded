...
public class FilterDataDao_Impl$2
extends EntityInsertionAdapter {
    public final /* synthetic */ FilterDataDao_Impl this$0;

    public FilterDataDao_Impl$2(FilterDataDao_Impl filterDataDao_Impl, RoomDatabase roomDatabase) {
    ...
    public String createQuery() {
        return "INSERT OR IGNORE INTO `filter_data` (`type_id`,`size`,`path`,`thumb`,`hash`,`main_sort`,`licensePath`,`licenseName`,`requiredPrime`,`id`,`res_id`,`label`,`label_tw`,`label_en`,`sort`) VALUES (?,?,?,?,?,?,?,?,?,nullif(?, 0),?,?,?,?,?)";
    }
}
