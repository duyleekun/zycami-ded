...
public class CaptionStyleDao_Impl$1
extends EntityInsertionAdapter {
    public final /* synthetic */ CaptionStyleDao_Impl this$0;

    public CaptionStyleDao_Impl$1(CaptionStyleDao_Impl captionStyleDao_Impl, RoomDatabase roomDatabase) {
    ...
    public String createQuery() {
        return "INSERT OR REPLACE INTO `caption_style_data` (`size`,`path`,`hash`,`thumb`,`licensePath`,`licenseName`,`requiredPrime`,`id`,`res_id`,`label`,`label_tw`,`label_en`,`sort`) VALUES (?,?,?,?,?,?,?,nullif(?, 0),?,?,?,?,?)";
    }
}
