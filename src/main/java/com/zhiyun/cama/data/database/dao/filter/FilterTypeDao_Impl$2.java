...
public class FilterTypeDao_Impl$2
extends EntityInsertionAdapter {
    public final /* synthetic */ FilterTypeDao_Impl this$0;

    public FilterTypeDao_Impl$2(FilterTypeDao_Impl filterTypeDao_Impl, RoomDatabase roomDatabase) {
    ...
    public String createQuery() {
        return "INSERT OR IGNORE INTO `filter_type` (`thumb`,`id`,`res_id`,`label`,`label_tw`,`label_en`,`sort`) VALUES (?,nullif(?, 0),?,?,?,?,?)";
    }
}
