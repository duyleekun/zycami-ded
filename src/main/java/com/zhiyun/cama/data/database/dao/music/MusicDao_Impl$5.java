...
public class MusicDao_Impl$5
extends SharedSQLiteStatement {
    public final /* synthetic */ MusicDao_Impl this$0;

    public MusicDao_Impl$5(MusicDao_Impl musicDao_Impl, RoomDatabase roomDatabase) {
        this.this$0 = musicDao_Impl;
        super(roomDatabase);
    }

    public String createQuery() {
        return "DELETE FROM music_data WHERE album_id < 0";
    }
}
