...
public class TransitionFileDao_Impl$1
extends EntityInsertionAdapter {
    public final /* synthetic */ TransitionFileDao_Impl this$0;

    public TransitionFileDao_Impl$1(TransitionFileDao_Impl transitionFileDao_Impl, RoomDatabase roomDatabase) {
    ...
    public String createQuery() {
        return "INSERT OR REPLACE INTO `transition_file` (`hash`,`name`,`category`,`mime`,`size`,`url`,`path`,`download_timestamp`,`ext_lic_url`,`ext_lic_name`,`ext_lic_path`) VALUES (?,?,?,?,?,?,?,?,?,?,?)";
    }
}
