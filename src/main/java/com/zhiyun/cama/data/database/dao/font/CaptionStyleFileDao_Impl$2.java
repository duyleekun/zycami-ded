...
public class CaptionStyleFileDao_Impl$2
extends EntityInsertionAdapter {
    public final /* synthetic */ CaptionStyleFileDao_Impl this$0;

    public CaptionStyleFileDao_Impl$2(CaptionStyleFileDao_Impl captionStyleFileDao_Impl, RoomDatabase roomDatabase) {
    ...
    public String createQuery() {
        return "INSERT OR IGNORE INTO `caption_style_file` (`hash`,`name`,`category`,`mime`,`size`,`url`,`path`,`download_timestamp`,`ext_lic_url`,`ext_lic_name`,`ext_lic_path`) VALUES (?,?,?,?,?,?,?,?,?,?,?)";
    }
}
