...
public class MusicFileDao_Impl$1
extends EntityInsertionAdapter {
    public final /* synthetic */ MusicFileDao_Impl this$0;

    public MusicFileDao_Impl$1(MusicFileDao_Impl musicFileDao_Impl, RoomDatabase roomDatabase) {
    ...
    public String createQuery() {
        return "INSERT OR REPLACE INTO `music_file` (`hash`,`name`,`category`,`mime`,`size`,`url`,`path`,`download_timestamp`,`ext_lic_url`,`ext_lic_name`,`ext_lic_path`) VALUES (?,?,?,?,?,?,?,?,?,?,?)";
    }
}
