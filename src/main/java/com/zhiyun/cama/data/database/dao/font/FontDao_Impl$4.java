...
public class FontDao_Impl$4
extends EntityDeletionOrUpdateAdapter {
    public final /* synthetic */ FontDao_Impl this$0;

    public FontDao_Impl$4(FontDao_Impl fontDao_Impl, RoomDatabase roomDatabase) {
    ...
    public String createQuery() {
        return "UPDATE OR REPLACE `font_data` SET `size` = ?,`path` = ?,`hash` = ?,`thumb` = ?,`requiredPrime` = ?,`id` = ?,`res_id` = ?,`label` = ?,`label_tw` = ?,`label_en` = ?,`sort` = ? WHERE `id` = ?";
    }
}
