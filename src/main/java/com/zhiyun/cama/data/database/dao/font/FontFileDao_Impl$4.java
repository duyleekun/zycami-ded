...
public class FontFileDao_Impl$4
extends EntityDeletionOrUpdateAdapter {
    public final /* synthetic */ FontFileDao_Impl this$0;

    public FontFileDao_Impl$4(FontFileDao_Impl fontFileDao_Impl, RoomDatabase roomDatabase) {
    ...
    public String createQuery() {
        return "UPDATE OR REPLACE `font_file` SET `hash` = ?,`name` = ?,`category` = ?,`mime` = ?,`size` = ?,`url` = ?,`path` = ?,`download_timestamp` = ?,`ext_lic_url` = ?,`ext_lic_name` = ?,`ext_lic_path` = ? WHERE `hash` = ?";
    }
}
