...
public class StickerDataDao_Impl$8
extends SharedSQLiteStatement {
    public final /* synthetic */ StickerDataDao_Impl this$0;

    public StickerDataDao_Impl$8(StickerDataDao_Impl stickerDataDao_Impl, RoomDatabase roomDatabase) {
        this.this$0 = stickerDataDao_Impl;
        super(roomDatabase);
    }

    public String createQuery() {
        return "UPDATE sticker_data SET path = ? WHERE hash = ?";
    }
}
