...
public class FontDao_Impl$1
extends EntityInsertionAdapter {
    public final /* synthetic */ FontDao_Impl this$0;

    public FontDao_Impl$1(FontDao_Impl fontDao_Impl, RoomDatabase roomDatabase) {
    ...
    public String createQuery() {
        return "INSERT OR REPLACE INTO `font_data` (`size`,`path`,`hash`,`thumb`,`requiredPrime`,`id`,`res_id`,`label`,`label_tw`,`label_en`,`sort`) VALUES (?,?,?,?,?,nullif(?, 0),?,?,?,?,?)";
    }
}
