...
public class StickerTypeDao_Impl$2
extends EntityInsertionAdapter {
    public final /* synthetic */ StickerTypeDao_Impl this$0;

    public StickerTypeDao_Impl$2(StickerTypeDao_Impl stickerTypeDao_Impl, RoomDatabase roomDatabase) {
    ...
    public String createQuery() {
        return "INSERT OR IGNORE INTO `sticker_type` (`id`,`res_id`,`label`,`label_tw`,`label_en`,`sort`) VALUES (nullif(?, 0),?,?,?,?,?)";
    }
}
