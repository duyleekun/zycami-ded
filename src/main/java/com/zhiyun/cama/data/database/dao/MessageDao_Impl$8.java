...
public class MessageDao_Impl$8
extends SharedSQLiteStatement {
    public final /* synthetic */ MessageDao_Impl this$0;

    public MessageDao_Impl$8(MessageDao_Impl messageDao_Impl, RoomDatabase roomDatabase) {
        this.this$0 = messageDao_Impl;
        super(roomDatabase);
    }

    public String createQuery() {
        return "DELETE FROM MessageSystem WHERE id=?";
    }
}
