...
public class AlbumDao_Impl$1
extends EntityInsertionAdapter {
    public final /* synthetic */ AlbumDao_Impl this$0;

    public AlbumDao_Impl$1(AlbumDao_Impl albumDao_Impl, RoomDatabase roomDatabase) {
    ...
    public String createQuery() {
        return "INSERT OR REPLACE INTO `album_data` (`cover_url`,`song_count`,`id`,`res_id`,`label`,`label_tw`,`label_en`,`sort`) VALUES (?,?,nullif(?, 0),?,?,?,?,?)";
    }
}
