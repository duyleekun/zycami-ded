...
public class MusicInfoDataDao_Impl$1
extends EntityInsertionAdapter {
    public final /* synthetic */ MusicInfoDataDao_Impl this$0;

    public MusicInfoDataDao_Impl$1(MusicInfoDataDao_Impl musicInfoDataDao_Impl, RoomDatabase roomDatabase) {
    ...
    public String createQuery() {
        return "INSERT OR REPLACE INTO `music_info_data` (`id`,`musicName`,`albumType`,`albumName`,`musicPath`,`musicUrl`,`musicImage`,`duration`,`size`,`import_timestamp`) VALUES (nullif(?, 0),?,?,?,?,?,?,?,?,?)";
    }
}
