...
public class TransitionDataDao_Impl$2
extends EntityInsertionAdapter {
    public final /* synthetic */ TransitionDataDao_Impl this$0;

    public TransitionDataDao_Impl$2(TransitionDataDao_Impl transitionDataDao_Impl, RoomDatabase roomDatabase) {
    ...
    public String createQuery() {
        return "INSERT OR IGNORE INTO `transition_data` (`size`,`path`,`hash`,`thumb`,`littleThumb`,`transitionType`,`licensePath`,`licenseName`,`requiredPrime`,`id`,`res_id`,`label`,`label_tw`,`label_en`,`sort`) VALUES (?,?,?,?,?,?,?,?,?,nullif(?, 0),?,?,?,?,?)";
    }
}
