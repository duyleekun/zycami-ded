...
public class StickerFileDao_Impl$2
extends EntityInsertionAdapter {
    public final /* synthetic */ StickerFileDao_Impl this$0;

    public StickerFileDao_Impl$2(StickerFileDao_Impl stickerFileDao_Impl, RoomDatabase roomDatabase) {
    ...
    public String createQuery() {
        return "INSERT OR IGNORE INTO `sticker_file` (`hash`,`name`,`category`,`mime`,`size`,`url`,`path`,`download_timestamp`,`ext_lic_url`,`ext_lic_name`,`ext_lic_path`) VALUES (?,?,?,?,?,?,?,?,?,?,?)";
    }
}
