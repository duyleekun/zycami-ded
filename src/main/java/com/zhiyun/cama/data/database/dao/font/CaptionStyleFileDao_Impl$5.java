...
public class CaptionStyleFileDao_Impl$5
extends SharedSQLiteStatement {
    public final /* synthetic */ CaptionStyleFileDao_Impl this$0;

    public CaptionStyleFileDao_Impl$5(CaptionStyleFileDao_Impl captionStyleFileDao_Impl, RoomDatabase roomDatabase) {
        this.this$0 = captionStyleFileDao_Impl;
        super(roomDatabase);
    }

    public String createQuery() {
        return "DELETE FROM caption_style_file WHERE hash < 0";
    }
}
