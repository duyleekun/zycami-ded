...
public class MusicDao_Impl$2
extends EntityInsertionAdapter {
    public final /* synthetic */ MusicDao_Impl this$0;

    public MusicDao_Impl$2(MusicDao_Impl musicDao_Impl, RoomDatabase roomDatabase) {
    ...
    public String createQuery() {
        return "INSERT OR IGNORE INTO `music_data` (`album_id`,`thumb`,`hash`,`duration`,`size`,`path`,`file_download_timestamp`,`requiredPrime`,`id`,`res_id`,`label`,`label_tw`,`label_en`,`sort`) VALUES (?,?,?,?,?,?,?,?,nullif(?, 0),?,?,?,?,?)";
    }
}
