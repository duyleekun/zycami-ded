...
public class BleViewModel$q
extends d.v.e0.ke.a {
    public final /* synthetic */ BleViewModel a;

    public BleViewModel$q(BleViewModel bleViewModel) {
        this.a = bleViewModel;
    }
    ...
    public void a() {
        ...
        object = new Object[1];
        BleViewModel$JoystickEvent bleViewModel$JoystickEvent = BleViewModel$JoystickEvent.RIGHT;
