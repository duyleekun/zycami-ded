...
public class BleViewModel$p
extends d.v.e0.ke.a {
    public final /* synthetic */ BleViewModel a;

    public BleViewModel$p(BleViewModel bleViewModel) {
        this.a = bleViewModel;
    }
    ...
    public void a() {
        ...
        object = new Object[1];
        BleViewModel$JoystickEvent bleViewModel$JoystickEvent = BleViewModel$JoystickEvent.UP;
