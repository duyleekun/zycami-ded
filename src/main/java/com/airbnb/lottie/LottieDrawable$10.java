...
public class LottieDrawable$10
implements LottieDrawable$LazyCompositionTask {
    ...
    public LottieDrawable$10(LottieDrawable lottieDrawable, String string2) {
    ...
    public void run(LottieComposition object) {
        ...
        ((LottieDrawable)((Object)object)).setMinAndMaxFrame(string2);
    }
}
