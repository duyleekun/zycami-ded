...
public class TXLiveConstants {
    ...
    public static final int AUTO_ADJUST_NONE = 255;
    ...
    public static final int PLAY_ERR_FILE_NOT_FOUND = 63233;
    public static final int PLAY_ERR_GET_PLAYINFO_FAIL = 63230;
    public static final int PLAY_ERR_GET_RTMP_ACC_URL_FAIL = 63234;
    public static final int PLAY_ERR_HEVC_DECODE_FAIL = 63232;
    public static final int PLAY_ERR_HLS_KEY = 63231;
    public static final int PLAY_ERR_NET_DISCONNECT = 63235;
    public static final int PLAY_ERR_STREAM_SWITCH_FAIL = 63229;
    ...
    public static final int PUSH_ERR_AUDIO_ENCODE_FAIL = 64232;
    public static final int PUSH_ERR_INVALID_ADDRESS = 64223;
    public static final int PUSH_ERR_MIC_RECORD_FAIL = 64225;
    public static final int PUSH_ERR_NET_DISCONNECT = 64229;
    public static final int PUSH_ERR_OPEN_CAMERA_FAIL = 64235;
    public static final int PUSH_ERR_OPEN_MIC_FAIL = 64234;
    public static final int PUSH_ERR_SCREEN_CAPTURE_DISTURBED = 64226;
    public static final int PUSH_ERR_SCREEN_CAPTURE_START_FAILED = 64228;
    public static final int PUSH_ERR_SCREEN_CAPTURE_SWITCH_DISPLAY_FAILED = 64224;
    public static final int PUSH_ERR_SCREEN_CAPTURE_UNSURPORT = 64227;
    public static final int PUSH_ERR_UNSUPPORTED_RESOLUTION = 64231;
    public static final int PUSH_ERR_UNSUPPORTED_SAMPLERATE = 64230;
    public static final int PUSH_ERR_VIDEO_ENCODE_FAIL = 64233;
