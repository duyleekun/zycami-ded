...
public class TXEAudioDef {
    ...
    public static final int TXE_AUDIO_COMMON_ERR_INVALID_PARAMS = 64635;
    ...
    public static final int TXE_AUDIO_PLAY_ERR_AUDIO_TYPE_NOT_SUPPORT = 154;
    public static final int TXE_AUDIO_PLAY_ERR_INVALID_STATE = 155;
    public static final int TXE_AUDIO_PLAY_ERR_NOT_CREATE_JIT = 151;
    public static final int TXE_AUDIO_PLAY_ERR_OK = 0;
    public static final int TXE_AUDIO_PLAY_ERR_REPEAT_OPTION = 152;
    public static final int TXE_AUDIO_PLAY_ERR_START_HW_DECODEC_FAILED = 153;
    public static final int TXE_AUDIO_RECORD_ERR_CAPTURE_DATA_INVALID = 252;
    public static final int TXE_AUDIO_RECORD_ERR_CUR_PLAYER_INVALID = 251;
    public static final int TXE_AUDIO_RECORD_ERR_CUR_RECORDER_INVALID = 150;
    public static final int TXE_AUDIO_RECORD_ERR_NOT_START = 253;
    public static final int TXE_AUDIO_RECORD_ERR_NO_MIC_PERMIT = 255;
    public static final int TXE_AUDIO_RECORD_ERR_OK = 0;
    public static final int TXE_AUDIO_RECORD_ERR_REPEAT_OPTION = 254;
    public static final int TXE_AUDIO_RECORD_FIRST_FRAME = 250;
    public static final int TXE_AUDIO_RECORD_RELEASE_MIC = 249;
    public static final int TXE_CHANGER_TYPE_0 = 255;
