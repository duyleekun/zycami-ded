...
public final class TXAudioEffectManagerImpl$3
implements Runnable {
    public final /* synthetic */ int val$errCode;
    public final /* synthetic */ long val$id;

    public TXAudioEffectManagerImpl$3(long l10, int n10) {
        this.val$id = l10;
    ...
    public void run() {
        ...
        ((StringBuilder)object).append("onEffectFinish -> effect id = ");
