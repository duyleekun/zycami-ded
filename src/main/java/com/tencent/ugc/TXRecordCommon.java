...
public class TXRecordCommon {
    ...
    public static final int RECORD_RESULT_COMPOSE_CANCEL = 249;
    public static final int RECORD_RESULT_COMPOSE_INTERNAL_ERR = 247;
    public static final int RECORD_RESULT_COMPOSE_SET_DST_PATH_ERR = 251;
    public static final int RECORD_RESULT_COMPOSE_SET_SRC_PATH_ERR = 252;
    public static final int RECORD_RESULT_COMPOSE_START_ERR = 250;
    public static final int RECORD_RESULT_COMPOSE_VERIFY_FAIL = 248;
    public static final int RECORD_RESULT_FAILED = 255;
    public static final int RECORD_RESULT_FILE_ERR = 253;
    ...
    public static final int RECORD_RESULT_SUSPEND_FOR_NO_TASK = 254;
    ...
    public static final int START_RECORD_ERR_API_IS_LOWER_THAN_18 = 253;
    public static final int START_RECORD_ERR_IS_IN_RECORDING = 255;
    public static final int START_RECORD_ERR_LICENCE_VERIFICATION_FAILED = 251;
    public static final int START_RECORD_ERR_NOT_INIT = 252;
    public static final int START_RECORD_ERR_VIDEO_PATH_IS_EMPTY = 254;
