...
extends NvsFx {
    ...
    private native List nativeGetCaptionBoundingVertices(long var1, int var3, NvsCaption$MotionParameters var4);
    ...
    private native RectF nativeGetTextBoundingRect(long var1);
    ...
    public List getCaptionBoundingVertices(int n10, NvsCaption$MotionParameters nvsCaption$MotionParameters) {
        NvsUtils.checkFunctionInMainThread();
        long l10 = this.m_internalObject;
        return this.nativeGetCaptionBoundingVertices(l10, n10, nvsCaption$MotionParameters);
    }
    ...
    public RectF getTextBoundingRect() {
        NvsUtils.checkFunctionInMainThread();
        long l10 = this.m_internalObject;
        return this.nativeGetTextBoundingRect(l10);
    }
    ...
    public void rotateCaption(float f10) {
        NvsUtils.checkFunctionInMainThread();
        RectF rectF = this.getTextBoundingRect();
