...
import com.meicam.sdk.NvsCaption$MotionParameters;
import com.meicam.sdk.NvsColor;
import com.meicam.sdk.NvsFx;
import com.meicam.sdk.NvsUtils;
import java.util.List;

public class NvsCompoundCaption
extends NvsFx {
    ...
    private native List nativeGetCaptionBoundingVertices(long var1, int var3, int var4, NvsCaption$MotionParameters var5);
    ...
    private native List nativeGetCompoundBoundingVertices(long var1, int var3, NvsCaption$MotionParameters var4);
    ...
    public List getCaptionBoundingVertices(int n10, int n11) {
        NvsUtils.checkFunctionInMainThread();
        long l10 = this.m_internalObject;
        return this.nativeGetCaptionBoundingVertices(l10, n10, n11, null);
    }

    public List getCaptionBoundingVertices(int n10, int n11, NvsCaption$MotionParameters nvsCaption$MotionParameters) {
        NvsUtils.checkFunctionInMainThread();
        long l10 = this.m_internalObject;
        return this.nativeGetCaptionBoundingVertices(l10, n10, n11, nvsCaption$MotionParameters);
    }
    ...
    public List getCompoundBoundingVertices(int n10) {
        NvsUtils.checkFunctionInMainThread();
        long l10 = this.m_internalObject;
        return this.nativeGetCompoundBoundingVertices(l10, n10, null);
    }

    public List getCompoundBoundingVertices(int n10, NvsCaption$MotionParameters nvsCaption$MotionParameters) {
        NvsUtils.checkFunctionInMainThread();
        long l10 = this.m_internalObject;
        return this.nativeGetCompoundBoundingVertices(l10, n10, nvsCaption$MotionParameters);
    }
