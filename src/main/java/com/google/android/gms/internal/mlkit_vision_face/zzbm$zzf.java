...
import com.google.android.gms.internal.mlkit_vision_face.zzbm$zzf$zzb;
...
public final class zzbm$zzf
extends zzgd
implements zzhn {
    private static final zzbm$zzf zzg;
    private static volatile zzhv zzh;
    private int zzc;
    private zzbm$zzf$zza zzd;
    private int zze;
    private zzbm$zzab zzf;

    static {
        zzbm$zzf zzbm$zzf;
        zzg = zzbm$zzf = new zzbm$zzf();
        zzgd.zza(zzbm$zzf.class, zzbm$zzf);
    }

    private zzbm$zzf() {
    }

    public static /* synthetic */ zzbm$zzf zza() {
        return zzg;
    }
