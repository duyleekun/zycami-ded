...
RandomAccess {
    ...
    private zzft(int[] nArray, int n10) {
        this.zzb = nArray;
        this.zzc = n10;
    }
    ...
    public final boolean addAll(Collection object) {
        this.zzc();
        zzfs.zza(object);
        int n10 = object instanceof zzft;
        if (n10 == 0) {
        ...
        if (n12 >= n10) {
            ...
            nArray = ((zzft)object).zzb;
            int[] nArray2 = this.zzb;
            int n13 = this.zzc;
            int n14 = ((zzft)object).zzc;
    ...
    public final boolean equals(Object object) {
        ...
        object = (zzft)object;
        n10 = this.zzc;
        int n11 = ((zzft)object).zzc;
        if (n10 != n11) {
            return false;
        }
        object = ((zzft)object).zzb;
    ...
    public final /* synthetic */ zzfy zzb(int n10) {
        ...
        if (n10 >= n11) {
            ...
            int n12 = this.zzc;
            zzft zzft2 = new zzft(nArray, n12);
            return zzft2;
        }
