...
import com.google.android.gms.internal.mlkit_vision_face.zzbm$zzu$zza;
...
public final class zzbm$zzu
extends zzgd
implements zzhn {
    private static final zzbm$zzu zzg;
    ...
    static {
        zzbm$zzu zzbm$zzu;
        zzg = zzbm$zzu = new zzbm$zzu();
        zzgd.zza(zzbm$zzu.class, zzbm$zzu);
    }

    private zzbm$zzu() {
    }

    public static /* synthetic */ zzbm$zzu zza() {
        return zzg;
    }
