...
import com.google.android.gms.internal.mlkit_vision_face.zzbm$zzp$zza;
...
public final class zzbm$zzp
extends zzgd
implements zzhn {
    private static final zzbm$zzp zzg;
    ...
    static {
        zzbm$zzp zzbm$zzp;
        zzg = zzbm$zzp = new zzbm$zzp();
        zzgd.zza(zzbm$zzp.class, zzbm$zzp);
    }

    private zzbm$zzp() {
    }

    public static /* synthetic */ zzbm$zzp zza() {
        return zzg;
    }
