...
import com.google.android.gms.internal.mlkit_vision_common.zzhf$zza;
import com.google.android.gms.internal.mlkit_vision_common.zzhf$zzb;
import com.google.android.gms.internal.mlkit_vision_common.zzhf$zzc;
...
public final class zzhf {
    ...
    private static final zzhf$zzd zzg;
    ...
    static {
        ...
        zzb = Logger.getLogger(zzhf.class.getName());
        Object object3 = zzhf.zzc();
        zzc = object3;
        zzd = zzdd.zzb();
        Class<Long> clazz5 = Long.TYPE;
        zze = bl2 = zzhf.zzd(clazz5);
        Class<Integer> clazz6 = Integer.TYPE;
        zzf = n10 = zzhf.zzd(clazz6);
        zzhf$zzd zzhf$zzd = null;
        if (object3 != null) {
            boolean bl3 = zzdd.zza();
            if (bl3) {
                if (bl2) {
                    zzhf$zzd = new zzhf$zzc((Unsafe)object3);
                } else if (n10 != 0) {
                    zzhf$zzd = new zzhf$zza((Unsafe)object3);
                }
            } else {
                zzhf$zzd = new zzhf$zzb((Unsafe)object3);
            }
        }
        zzg = zzhf$zzd;
        zzh = zzhf.zze();
        zzi = zzhf.zzd();
        object3 = byte[].class;
        int n11 = zzhf.zzb((Class)object3);
        zzj = l16 = (long)n11;
        n10 = zzhf.zzb(clazz4);
        zzk = n10;
        zzl = zzhf.zzc(clazz4);
        int n12 = zzhf.zzb(clazz3);
        zzm = l15 = (long)n12;
        zzn = zzhf.zzc(clazz3);
        int n13 = zzhf.zzb(clazz2);
        zzo = l14 = (long)n13;
        zzp = zzhf.zzc(clazz2);
        int n14 = zzhf.zzb(clazz);
        zzq = l13 = (long)n14;
        zzr = zzhf.zzc(clazz);
        int n15 = zzhf.zzb(object2);
        zzs = l12 = (long)n15;
        zzt = zzhf.zzc(object2);
        int n16 = zzhf.zzb(object);
        zzu = l11 = (long)n16;
        int n17 = zzhf.zzc(object);
        zzv = l10 = (long)n17;
        object = zzhf.zzf();
        if (object != null && zzhf$zzd != null) {
            object2 = zzhf$zzd.zza;
    ...
    public static byte zza(byte[] byArray, long l10) {
        zzhf$zzd zzhf$zzd = zzg;
        long l11 = zzj + l10;
        return zzhf$zzd.zza(byArray, l11);
    }
    ...
    public static void zza(Object object, long l10, Object object2) {
        zzhf.zzg.zza.putObject(object, l10, object2);
    }
    ...
    public static void zza(byte[] byArray, long l10, byte by2) {
        zzhf$zzd zzhf$zzd = zzg;
        long l11 = zzj + l10;
        zzhf$zzd.zza((Object)byArray, l11, by2);
    }
    ...
    private static int zzb(Class clazz) {
        boolean bl2 = zzi;
        if (bl2) {
            return zzhf.zzg.zza.arrayBaseOffset(clazz);
        }
        return -1;
    }
    ...
    private static int zzc(Class clazz) {
        boolean bl2 = zzi;
        if (bl2) {
            return zzhf.zzg.zza.arrayIndexScale(clazz);
        }
        return -1;
    }

    public static Unsafe zzc() {
        Object object = new zzhh();
    ...
    public static Object zzf(Object object, long l10) {
        return zzhf.zzg.zza.getObject(object, l10);
    }
    ...
    private static Field zzf() {
        ...
        Field field;
        boolean bl2 = zzdd.zza();
        if (bl2 && (field = zzhf.zza(Buffer.class, (String)(object = "effectiveDirectAddress"))) != null) {
            return field;
        }
        object = "address";
        field = zzhf.zza(Buffer.class, (String)object);
    ...
    private static boolean zzm(Object object, long l10) {
        byte by2 = zzhf.zzk(object, l10);
        return by2 != 0;
    }

    private static boolean zzn(Object object, long l10) {
        byte by2 = zzhf.zzl(object, l10);
        return by2 != 0;
    }
}
