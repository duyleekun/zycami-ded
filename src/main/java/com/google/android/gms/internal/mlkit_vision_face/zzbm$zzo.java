...
import com.google.android.gms.internal.mlkit_vision_face.zzbm$zzo$zza;
...
public final class zzbm$zzo
extends zzgd
implements zzhn {
    private static final zzbm$zzo zzg;
    ...
    static {
        zzbm$zzo zzbm$zzo;
        zzg = zzbm$zzo = new zzbm$zzo();
        zzgd.zza(zzbm$zzo.class, zzbm$zzo);
    }

    private zzbm$zzo() {
    }

    public static /* synthetic */ zzbm$zzo zza() {
        return zzg;
    }
