...
extends zzfc {
    ...
    public zzfc$zza(byte[] object, int n10, int n11) {
        super(null);
    ...
    private final void zzc(byte[] byArray, int n10, int n11) {
        ...
        try {
            ...
            zzfc$zzb zzfc$zzb = new zzfc$zzb((String)object, indexOutOfBoundsException);
            throw zzfc$zzb;
        }
        int n13 = this.zze;
    ...
    public final void zza(int n10, zzhb zzhb2) {
        int n11 = 1;
        int n12 = 3;
        ((zzfc)this).zza(n11, n12);
        int n13 = 2;
        ((zzfc)this).zzc(n13, n10);
        ((zzfc)this).zza(n12, n13);
        ((zzfc)this).zza(zzhb2);
        ((zzfc)this).zza(n11, 4);
    }

    public final void zza(int n10, zzhb zzhb2, zzhr zzhr2) {
        ((zzfc)this).zza(n10, 2);
        Object object = zzhb2;
        object = (zzeg)zzhb2;
        int n11 = ((zzeg)object).zzg();
        int n12 = -1;
        if (n11 == n12) {
            n11 = zzhr2.zzd(object);
            ((zzeg)object).zza(n11);
        }
        ((zzfc)this).zzb(n11);
        object = this.zza;
        zzhr2.zza((Object)zzhb2, (zzjd)object);
    }

    public final void zza(int n10, String string2) {
        ((zzfc)this).zza(n10, 2);
        ((zzfc)this).zza(string2);
    }

    public final void zza(int n10, boolean bl2) {
        ((zzfc)this).zza(n10, 0);
        n10 = (byte)(bl2 ? 1 : 0);
        ((zzfc)this).zza((byte)n10);
    }
        ...
        if (var3_2 != 0 && (var3_2 = this.zza()) >= (var9_6 = 10)) {
            while (true) {
                if ((var3_2 = (int)((cfr_temp_0 = (var10_10 = var1_1 & var7_5) - var5_4) == 0L ? 0 : (cfr_temp_0 < 0L ? -1 : 1))) == 0) {
                    ...
                    zzip.zza(var12_12, var14_16, var16_17);
                    return;
                }
                var12_12 = this.zzb;
                var9_6 = this.zze;
                ...
                zzip.zza(var12_12, var10_10, var18_9);
                var1_1 >>>= var4_3;
            }
        }
        while (true) {
            ...
            var20_20 = new zzfc$zzb((String)var12_13 /* !! */ , var19_19);
            throw var20_20;
        }
        {
            var4_3 = this.zze;
...
lbl48:
    ...
    public final void zza(String string2) {
        ...
        try {
            ...
            if (n12 == n11) {
                ...
                int n13 = ((zzfc)this).zza();
                n11 = zzir.zza(string2, byArray, n11, n13);
                this.zze = n10;
                int n14 = n11 - n10 - n12;
                ((zzfc)this).zzb(n14);
                this.zze = n11;
            ...
            n11 = zzir.zza(string2);
            ((zzfc)this).zzb(n11);
            byte[] byArray = this.zzb;
            n12 = this.zze;
            int n15 = ((zzfc)this).zza();
            this.zze = n11 = zzir.zza(string2, byArray, n12, n15);
            return;
        }
        catch (IndexOutOfBoundsException indexOutOfBoundsException) {
            zzfc$zzb zzfc$zzb = new zzfc$zzb(indexOutOfBoundsException);
            throw zzfc$zzb;
        }
        catch (zzis zzis2) {
            this.zze = n10;
            this.zza(string2, zzis2);
            return;
        }
    }
    ...
    public final void zzb(int var1_1) {
        var2_2 = zzfc.zzc();
        if (var2_2 != 0 && (var2_2 = zzen.zza()) == 0 && (var2_2 = this.zza()) >= (var3_3 = 5)) {
            var2_2 = var1_1 & -128;
            if (var2_2 == 0) {
                var4_4 = this.zzb;
                var3_3 = this.zze;
                ...
                var6_10 = var3_3;
                var1_1 = (byte)var1_1;
                zzip.zza(var4_4, var6_10, (byte)var1_1);
                return;
            }
            var4_5 = this.zzb;
            var3_3 = this.zze;
            ...
            zzip.zza(var4_5, var6_11, var8_12);
            var2_2 = (var1_1 >>>= 7) & -128;
            if (var2_2 == 0) {
                var4_5 = this.zzb;
                var3_3 = this.zze;
                ...
                var6_11 = var3_3;
                var1_1 = (byte)var1_1;
                zzip.zza(var4_5, var6_11, (byte)var1_1);
                return;
            }
            var4_5 = this.zzb;
            var3_3 = this.zze;
...
lbl97:
    ...
    public final void zzb(int n10, zzep zzep2) {
        int n11 = 1;
        int n12 = 3;
        ((zzfc)this).zza(n11, n12);
        ((zzfc)this).zzc(2, n10);
        ((zzfc)this).zza(n12, zzep2);
        ((zzfc)this).zza(n11, 4);
    }
