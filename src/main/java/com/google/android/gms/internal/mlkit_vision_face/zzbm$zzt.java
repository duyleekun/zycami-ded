...
import com.google.android.gms.internal.mlkit_vision_face.zzbm$zzt$zza;
...
public final class zzbm$zzt
extends zzgd
implements zzhn {
    private static final zzbm$zzt zzg;
    ...
    static {
        zzbm$zzt zzbm$zzt;
        zzg = zzbm$zzt = new zzbm$zzt();
        zzgd.zza(zzbm$zzt.class, zzbm$zzt);
    }

    private zzbm$zzt() {
    }

    public static /* synthetic */ zzbm$zzt zza() {
        return zzg;
    }
