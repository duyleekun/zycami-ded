...
import com.google.android.gms.internal.mlkit_vision_face.zzbm$zzr$zza;
...
public final class zzbm$zzr
extends zzgd
implements zzhn {
    private static final zzbm$zzr zzg;
    ...
    static {
        zzbm$zzr zzbm$zzr;
        zzg = zzbm$zzr = new zzbm$zzr();
        zzgd.zza(zzbm$zzr.class, zzbm$zzr);
    }

    private zzbm$zzr() {
    }

    public static /* synthetic */ zzbm$zzr zza() {
        return zzg;
    }
