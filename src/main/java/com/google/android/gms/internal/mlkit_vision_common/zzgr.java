...
Map.Entry {
    ...
    public zzgr(zzgm zzgm2, Comparable comparable, Object object) {
        this.zzc = zzgm2;
        this.zza = comparable;
        this.zzb = object;
    }

    public zzgr(zzgm zzgm2, Map.Entry entry) {
        Comparable comparable = (Comparable)entry.getKey();
        entry = entry.getValue();
        this(zzgm2, comparable, entry);
    }
    ...
    public final /* synthetic */ int compareTo(Object object) {
        ...
        object = (Comparable)((zzgr)object).getKey();
    ...
    public final boolean equals(Object object) {
        ...
        bl4 = zzgr.zza(object2, k10);
        if (bl4 && (bl2 = zzgr.zza(object2 = this.zzb, object = object.getValue()))) {
            return bl3;
        }
        return false;
    }
