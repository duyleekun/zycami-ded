...
extends zzdw {
    ...
    public zzdw$zzb(byte[] object, int n10, int n11) {
        super(null);
    ...
    private final void zzc(byte[] byArray, int n10, int n11) {
        ...
        try {
            ...
            zzdw$zza zzdw$zza = new zzdw$zza((String)object, indexOutOfBoundsException);
            throw zzdw$zza;
        }
        int n13 = this.zze;
    ...
    public final void zza(int n10, zzfr zzfr2) {
        int n11 = 1;
        int n12 = 3;
        ((zzdw)this).zza(n11, n12);
        int n13 = 2;
        ((zzdw)this).zzc(n13, n10);
        ((zzdw)this).zza(n12, n13);
        ((zzdw)this).zza(zzfr2);
        ((zzdw)this).zza(n11, 4);
    }

    public final void zza(int n10, zzfr zzfr2, zzgh zzgh2) {
        ((zzdw)this).zza(n10, 2);
        Object object = zzfr2;
        object = (zzda)zzfr2;
        int n11 = ((zzda)object).zzg();
        int n12 = -1;
        if (n11 == n12) {
            n11 = zzgh2.zzb(object);
            ((zzda)object).zza(n11);
        }
        ((zzdw)this).zzb(n11);
        object = this.zza;
        zzgh2.zza((Object)zzfr2, (zzht)object);
    }

    public final void zza(int n10, String string2) {
        ((zzdw)this).zza(n10, 2);
        ((zzdw)this).zza(string2);
    }

    public final void zza(int n10, boolean bl2) {
        ((zzdw)this).zza(n10, 0);
        n10 = (byte)(bl2 ? 1 : 0);
        ((zzdw)this).zza((byte)n10);
    }
        ...
        if (var3_2 != 0 && (var3_2 = this.zza()) >= (var9_6 = 10)) {
            while (true) {
                if ((var3_2 = (int)((cfr_temp_0 = (var10_10 = var1_1 & var7_5) - var5_4) == 0L ? 0 : (cfr_temp_0 < 0L ? -1 : 1))) == 0) {
                    ...
                    zzhf.zza(var12_12, var14_16, var16_17);
                    return;
                }
                var12_12 = this.zzb;
                var9_6 = this.zze;
                ...
                zzhf.zza(var12_12, var10_10, var18_9);
                var1_1 >>>= var4_3;
            }
        }
        while (true) {
            ...
            var20_20 = new zzdw$zza((String)var12_13 /* !! */ , var19_19);
            throw var20_20;
        }
        {
            var4_3 = this.zze;
...
lbl48:
    ...
    public final void zza(String string2) {
        ...
        try {
            ...
            if (n12 == n11) {
                ...
                int n13 = ((zzdw)this).zza();
                n11 = zzhi.zza(string2, byArray, n11, n13);
                this.zze = n10;
                int n14 = n11 - n10 - n12;
                ((zzdw)this).zzb(n14);
                this.zze = n11;
            ...
            n11 = zzhi.zza(string2);
            ((zzdw)this).zzb(n11);
            byte[] byArray = this.zzb;
            n12 = this.zze;
            int n15 = ((zzdw)this).zza();
            this.zze = n11 = zzhi.zza(string2, byArray, n12, n15);
            return;
        }
        catch (IndexOutOfBoundsException indexOutOfBoundsException) {
            zzdw$zza zzdw$zza = new zzdw$zza(indexOutOfBoundsException);
            throw zzdw$zza;
        }
        catch (zzhm zzhm2) {
            this.zze = n10;
            this.zza(string2, zzhm2);
            return;
        }
    }
    ...
    public final void zzb(int var1_1) {
        var2_2 = zzdw.zzc();
        if (var2_2 != 0 && (var2_2 = zzdd.zza()) == 0 && (var2_2 = this.zza()) >= (var3_3 = 5)) {
            var2_2 = var1_1 & -128;
            if (var2_2 == 0) {
                var4_4 = this.zzb;
                var3_3 = this.zze;
                ...
                var6_10 = var3_3;
                var1_1 = (byte)var1_1;
                zzhf.zza(var4_4, var6_10, (byte)var1_1);
                return;
            }
            var4_5 = this.zzb;
            var3_3 = this.zze;
            ...
            zzhf.zza(var4_5, var6_11, var8_12);
            var2_2 = (var1_1 >>>= 7) & -128;
            if (var2_2 == 0) {
                var4_5 = this.zzb;
                var3_3 = this.zze;
                ...
                var6_11 = var3_3;
                var1_1 = (byte)var1_1;
                zzhf.zza(var4_5, var6_11, (byte)var1_1);
                return;
            }
            var4_5 = this.zzb;
            var3_3 = this.zze;
...
lbl97:
    ...
    public final void zzb(int n10, zzdf zzdf2) {
        int n11 = 1;
        int n12 = 3;
        ((zzdw)this).zza(n11, n12);
        ((zzdw)this).zzc(2, n10);
        ((zzdw)this).zza(n12, zzdf2);
        ((zzdw)this).zza(n11, 4);
    }
