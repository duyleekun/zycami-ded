...
import com.google.android.gms.internal.mlkit_common.zzip$zza;
import com.google.android.gms.internal.mlkit_common.zzip$zzb;
import com.google.android.gms.internal.mlkit_common.zzip$zzc;
import com.google.android.gms.internal.mlkit_common.zzip$zzd;
...
public final class zzip {
    ...
    private static final zzip$zzc zzg;
    ...
    static {
        ...
        zzb = Logger.getLogger(zzip.class.getName());
        Object object3 = zzip.zzc();
        zzc = object3;
        zzd = zzen.zzb();
        Class<Long> clazz5 = Long.TYPE;
        zze = bl2 = zzip.zzd(clazz5);
        Class<Integer> clazz6 = Integer.TYPE;
        zzf = n10 = zzip.zzd(clazz6);
        zzip$zzc zzip$zzc = null;
        if (object3 != null) {
            boolean bl3 = zzen.zza();
            if (bl3) {
                if (bl2) {
                    zzip$zzc = new zzip$zza((Unsafe)object3);
                } else if (n10 != 0) {
                    zzip$zzc = new zzip$zzb((Unsafe)object3);
                }
            } else {
                zzip$zzc = new zzip$zzd((Unsafe)object3);
            }
        }
        zzg = zzip$zzc;
        zzh = zzip.zze();
        zzi = zzip.zzd();
        object3 = byte[].class;
        int n11 = zzip.zzb((Class)object3);
        zzj = l16 = (long)n11;
        n10 = zzip.zzb(clazz4);
        zzk = n10;
        zzl = zzip.zzc(clazz4);
        int n12 = zzip.zzb(clazz3);
        zzm = l15 = (long)n12;
        zzn = zzip.zzc(clazz3);
        int n13 = zzip.zzb(clazz2);
        zzo = l14 = (long)n13;
        zzp = zzip.zzc(clazz2);
        int n14 = zzip.zzb(clazz);
        zzq = l13 = (long)n14;
        zzr = zzip.zzc(clazz);
        int n15 = zzip.zzb(object2);
        zzs = l12 = (long)n15;
        zzt = zzip.zzc(object2);
        int n16 = zzip.zzb(object);
        zzu = l11 = (long)n16;
        int n17 = zzip.zzc(object);
        zzv = l10 = (long)n17;
        object = zzip.zzf();
        if (object != null && zzip$zzc != null) {
            object2 = zzip$zzc.zza;
    ...
    public static byte zza(byte[] byArray, long l10) {
        zzip$zzc zzip$zzc = zzg;
        long l11 = zzj + l10;
        return zzip$zzc.zza(byArray, l11);
    }
    ...
    public static void zza(Object object, long l10, Object object2) {
        zzip.zzg.zza.putObject(object, l10, object2);
    }
    ...
    public static void zza(byte[] byArray, long l10, byte by2) {
        zzip$zzc zzip$zzc = zzg;
        long l11 = zzj + l10;
        zzip$zzc.zza((Object)byArray, l11, by2);
    }
    ...
    private static int zzb(Class clazz) {
        boolean bl2 = zzi;
        if (bl2) {
            return zzip.zzg.zza.arrayBaseOffset(clazz);
        }
        return -1;
    }
    ...
    private static int zzc(Class clazz) {
        boolean bl2 = zzi;
        if (bl2) {
            return zzip.zzg.zza.arrayIndexScale(clazz);
        }
        return -1;
    }

    public static Unsafe zzc() {
        Object object = new zzio();
    ...
    public static Object zzf(Object object, long l10) {
        return zzip.zzg.zza.getObject(object, l10);
    }
    ...
    private static Field zzf() {
        ...
        Field field;
        boolean bl2 = zzen.zza();
        if (bl2 && (field = zzip.zza(Buffer.class, (String)(object = "effectiveDirectAddress"))) != null) {
            return field;
        }
        object = "address";
        field = zzip.zza(Buffer.class, (String)object);
    ...
    private static boolean zzm(Object object, long l10) {
        byte by2 = zzip.zzk(object, l10);
        return by2 != 0;
    }

    private static boolean zzn(Object object, long l10) {
        byte by2 = zzip.zzl(object, l10);
        return by2 != 0;
    }
}
