...
import com.google.android.gms.internal.mlkit_vision_face.zzbm$zzs$zza;
...
public final class zzbm$zzs
extends zzgd
implements zzhn {
    private static final zzbm$zzs zzg;
    ...
    static {
        zzbm$zzs zzbm$zzs;
        zzg = zzbm$zzs = new zzbm$zzs();
        zzgd.zza(zzbm$zzs.class, zzbm$zzs);
    }

    private zzbm$zzs() {
    }

    public static /* synthetic */ zzbm$zzs zza() {
        return zzg;
    }
