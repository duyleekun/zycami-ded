...
public final class zzhq {
    public static String zza(zzhl zzhl2, String string2) {
        StringBuilder stringBuilder = new StringBuilder();
        stringBuilder.append("# ");
        stringBuilder.append(string2);
        zzhq.zza(zzhl2, stringBuilder, 0);
     ...
     */
    private static void zza(zzhl var0, StringBuilder var1_1, int var2_2) {
        var3_3 = new HashMap();
                                            ...
                                            block20: {
                                                ...
                                                if (var13_13 != 0 && (var13_13 = (int)var16_16.endsWith((String)(var12_12 = "OrBuilderList"))) == 0 && (var19_19 = var16_16.equals(var11_11)) == 0) {
                                                    ...
                                                    if (var12_12 != null && (var20_20 = (int)(var21_21 = var12_12.getReturnType()).equals(var22_22 = List.class)) != 0) {
                                                        var6_6 = zzhq.zza(var11_11);
                                                        var16_16 = new Object[]{};
                                                        var16_16 = zzgd.zza((Method)var12_12, var0, (Object[])var16_16);
                                                        zzhq.zza(var1_1, var2_2, (String)var6_6, var16_16);
                                                        continue;
                                                    }
                                                }
                                                if ((var13_13 = (int)var16_16.endsWith((String)(var11_11 = "Map"))) != 0 && (var19_19 = var16_16.equals(var11_11)) == 0) {
                                                    ...
                                                    if ((var6_6 = (Method)var3_3.get(var6_6)) != null && (var19_19 = (int)(var11_11 = var6_6.getReturnType()).equals(var12_12 = Map.class)) != 0 && (var19_19 = (int)var6_6.isAnnotationPresent((Class<? extends Annotation>)(var11_11 = Deprecated.class))) == 0 && (var19_19 = (int)Modifier.isPublic(var6_6.getModifiers())) != 0) {
                                                        var16_16 = zzhq.zza((String)var9_9);
                                                        var9_9 = new Object[]{};
                                                        var6_6 = zzgd.zza((Method)var6_6, var0, (Object[])var9_9);
                                                        zzhq.zza(var1_1, var2_2, (String)var16_16, var6_6);
                                                        continue;
                                                    }
                                                }
                                                var6_6 = "set";
                                                ...
                                                var11_11 = new Object[]{};
                                                var9_9 = zzgd.zza((Method)var9_9, var0, var11_11);
...
lbl99:
                                ...
                                var7_7 = var9_9 instanceof zzez;
                                if (var7_7 == 0) break block24;
                                var16_16 = zzez.zza;
                                var7_7 = (int)var9_9.equals(var16_16);
                                break block18;
                            }
                            var7_7 = var9_9 instanceof zzhl;
                            if (var7_7 == 0) break block25;
                            var16_16 = var9_9;
                            var16_16 = ((zzhl)var9_9).zzi();
                ...
                var11_11 = new Object[]{};
                var16_16 = (Boolean)zzgd.zza((Method)var16_16, var0, var11_11);
                var17_17 = (int)var16_16.booleanValue();
            }
            if (var17_17 == 0) continue;
            var6_6 = zzhq.zza((String)var6_6);
            zzhq.zza(var1_1, var2_2, (String)var6_6, var9_9);
        }
        var28_26 = var0 instanceof zzgd$zze;
        if (var28_26) {
            var3_3 = var0;
            var3_3 = ((zzgd$zze)var0).zzc.zzd();
            var29_27 = var3_3.hasNext();
            if (var29_27) {
                var0 = (zzgd$zzd)((Map.Entry)var3_3.next()).getKey();
                var0 = new NoSuchMethodError();
                throw var0;
            }
        }
        if ((var0 = ((zzgd)var0).zzb) != null) {
    ...
    public static final void zza(StringBuilder stringBuilder, int n10, String string2, Object object) {
        ...
        if (n11 != 0) {
            ...
            while ((n11 = object.hasNext()) != 0) {
                ...
                zzhq.zza(stringBuilder, n10, string2, e10);
            }
            return;
        }
        ...
        if (n11 != 0) {
            ...
            while ((n11 = object.hasNext()) != 0) {
                ...
                zzhq.zza(stringBuilder, n10, string2, entry);
            }
            return;
        }
        stringBuilder.append('\n');
        ...
        if (n12 != 0) {
            ...
            String string5 = zzip.zza(zzez.zza((String)object));
        ...
        if (n12 != 0) {
            stringBuilder.append(string4);
            String string6 = zzip.zza((zzez)object);
            stringBuilder.append(string6);
            stringBuilder.append(c11);
            return;
        }
        n12 = object instanceof zzgd;
        string3 = "}";
        string4 = "\n";
        String string7 = " {";
        if (n12 != 0) {
            ...
            object = (zzgd)object;
            n12 = n10 + 2;
            zzhq.zza((zzhl)object, stringBuilder, n12);
            stringBuilder.append(string4);
            while (n11 < n10) {
                stringBuilder.append(c10);
                ++n11;
        ...
        if (n12 != 0) {
            ...
            String string8 = "key";
            zzhq.zza(stringBuilder, n12, string8, string7);
            object = object.getValue();
            string7 = "value";
            zzhq.zza(stringBuilder, n12, string7, object);
            stringBuilder.append(string4);
            while (n11 < n10) {
                stringBuilder.append(c10);
                ++n11;
