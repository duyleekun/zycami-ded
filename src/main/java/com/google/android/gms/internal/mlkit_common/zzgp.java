...
RandomAccess {
    ...
    private zzgp(long[] lArray, int n10) {
        this.zzb = lArray;
        this.zzc = n10;
    }
    ...
    public final boolean addAll(Collection object) {
        this.zzc();
        zzfs.zza(object);
        int n10 = object instanceof zzgp;
        if (n10 == 0) {
        ...
        if (n12 >= n10) {
            ...
            lArray = ((zzgp)object).zzb;
            long[] lArray2 = this.zzb;
            int n13 = this.zzc;
            int n14 = ((zzgp)object).zzc;
    ...
    public final boolean equals(Object object) {
        ...
        object = (zzgp)object;
        n10 = this.zzc;
        int n11 = ((zzgp)object).zzc;
        if (n10 != n11) {
            return false;
        }
        object = ((zzgp)object).zzb;
    ...
    public final /* synthetic */ zzfy zzb(int n10) {
        ...
        if (n10 >= n11) {
            ...
            int n12 = this.zzc;
            zzgp zzgp2 = new zzgp(lArray, n12);
            return zzgp2;
        }
