...
import com.google.android.gms.internal.mlkit_vision_face.zzbm$zzw$zza;
...
public final class zzbm$zzw
extends zzgd
implements zzhn {
    private static final zzbm$zzw zzg;
    ...
    static {
        zzbm$zzw zzbm$zzw;
        zzg = zzbm$zzw = new zzbm$zzw();
        zzgd.zza(zzbm$zzw.class, zzbm$zzw);
    }

    private zzbm$zzw() {
    }

    public static /* synthetic */ zzbm$zzw zza() {
        return zzg;
    }
