...
import com.google.android.gms.internal.mlkit_vision_common.zzgv;
...
public final class zzfw {
    public static String zza(zzfr zzfr2, String string2) {
        StringBuilder stringBuilder = new StringBuilder();
        stringBuilder.append("# ");
        stringBuilder.append(string2);
        zzfw.zza(zzfr2, stringBuilder, 0);
     ...
     */
    private static void zza(zzfr var0, StringBuilder var1_1, int var2_2) {
        var3_3 = new HashMap();
        var4_4 = new HashMap<Class<?>[], Method>();
        var5_5 = new TreeSet();
        ...
        while (true) {
            ...
            var4_4.put((Class<?>[])var12_12, (Method)var11_11);
                                            ...
                                            block20: {
                                                ...
                                                if (var13_13 != 0 && (var13_13 = (int)var16_16.endsWith((String)(var12_12 = "OrBuilderList"))) == 0 && (var19_19 = var16_16.equals(var11_11)) == 0) {
                                                    ...
                                                    if (var12_12 != null && (var20_20 = (int)(var21_21 = var12_12.getReturnType()).equals(var22_22 = List.class)) != 0) {
                                                        var6_6 = zzfw.zza(var11_11);
                                                        var16_16 = new Object[]{};
                                                        var16_16 = zzej.zza((Method)var12_12, var0, (Object[])var16_16);
                                                        zzfw.zza(var1_1, var2_2, (String)var6_6, var16_16);
                                                        continue;
                                                    }
                                                }
                                                if ((var13_13 = (int)var16_16.endsWith((String)(var11_11 = "Map"))) != 0 && (var19_19 = var16_16.equals(var11_11)) == 0) {
                                                    ...
                                                    if ((var6_6 = (Method)var3_3.get(var6_6)) != null && (var19_19 = (int)(var11_11 = var6_6.getReturnType()).equals(var12_12 = Map.class)) != 0 && (var19_19 = (int)var6_6.isAnnotationPresent((Class<? extends Annotation>)(var11_11 = Deprecated.class))) == 0 && (var19_19 = (int)Modifier.isPublic(var6_6.getModifiers())) != 0) {
                                                        var16_16 = zzfw.zza((String)var9_9);
                                                        var9_9 = new Object[]{};
                                                        var6_6 = zzej.zza((Method)var6_6, var0, (Object[])var9_9);
                                                        zzfw.zza(var1_1, var2_2, (String)var16_16, var6_6);
                                                        continue;
                                                    }
                                                }
                                                var6_6 = "set";
                                                ...
                                                if ((var6_6 = (Method)var4_4.get(var6_6)) == null || (var15_15 = var16_16.endsWith((String)(var6_6 = "Bytes"))) != 0 && (var15_15 = (int)var3_3.containsKey(var6_6 = (var8_8 = (var6_6 = String.valueOf(var16_16.substring(0, var15_15 = var16_16.length() + -5))).length()) != 0 ? var10_10.concat((String)var6_6) : new String(var10_10))) != 0) continue;
                                                ...
                                                var11_11 = new Object[]{};
                                                var9_9 = zzej.zza((Method)var9_9, var0, var11_11);
...
lbl99:
                                ...
                                var7_7 = var9_9 instanceof zzdf;
                                if (var7_7 == 0) break block24;
                                var16_16 = zzdf.zza;
                                var7_7 = (int)var9_9.equals(var16_16);
                                break block18;
                            }
                            var7_7 = var9_9 instanceof zzfr;
                            if (var7_7 == 0) break block25;
                            var16_16 = var9_9;
                            var16_16 = ((zzfr)var9_9).zzi();
                ...
                var11_11 = new Object[]{};
                var16_16 = (Boolean)zzej.zza((Method)var16_16, var0, var11_11);
                var17_17 = (int)var16_16.booleanValue();
            }
            if (var17_17 == 0) continue;
            var6_6 = zzfw.zza((String)var6_6);
            zzfw.zza(var1_1, var2_2, (String)var6_6, var9_9);
        }
        var28_26 = var0 instanceof zzej$zze;
        if (var28_26) {
            var3_3 = var0;
            var3_3 = ((zzej$zze)var0).zzc.zzd();
            var29_27 = var3_3.hasNext();
            if (var29_27) {
                var0 = (zzej$zzd)((Map.Entry)var3_3.next()).getKey();
                var0 = new NoSuchMethodError();
                throw var0;
            }
        }
        if ((var0 = ((zzej)var0).zzb) != null) {
    ...
    public static final void zza(StringBuilder stringBuilder, int n10, String string2, Object object) {
        ...
        if (n11 != 0) {
            ...
            while ((n11 = object.hasNext()) != 0) {
                ...
                zzfw.zza(stringBuilder, n10, string2, e10);
            }
            return;
        }
        ...
        if (n11 != 0) {
            ...
            while ((n11 = object.hasNext()) != 0) {
                ...
                zzfw.zza(stringBuilder, n10, string2, entry);
            }
            return;
        }
        stringBuilder.append('\n');
        ...
        if (n12 != 0) {
            ...
            String string5 = zzgv.zza(zzdf.zza((String)object));
        ...
        if (n12 != 0) {
            stringBuilder.append(string4);
            String string6 = zzgv.zza((zzdf)object);
            stringBuilder.append(string6);
            stringBuilder.append(c11);
            return;
        }
        n12 = object instanceof zzej;
        string3 = "}";
        string4 = "\n";
        String string7 = " {";
        if (n12 != 0) {
            ...
            object = (zzej)object;
            n12 = n10 + 2;
            zzfw.zza((zzfr)object, stringBuilder, n12);
            stringBuilder.append(string4);
            while (n11 < n10) {
                stringBuilder.append(c10);
                ++n11;
        ...
        if (n12 != 0) {
            ...
            String string8 = "key";
            zzfw.zza(stringBuilder, n12, string8, string7);
            object = object.getValue();
            string7 = "value";
            zzfw.zza(stringBuilder, n12, string7, object);
            stringBuilder.append(string4);
            while (n11 < n10) {
                stringBuilder.append(c10);
                ++n11;
