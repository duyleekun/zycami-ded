    ...
    private static int zza(byte[] object, int n10, long l10, int n11) {
        if (n11 != 0) {
            ...
            if (n11 != n12) {
                n12 = 2;
                if (n11 == n12) {
                    n11 = zzip.zza(object, l10);
                    byte by2 = zzip.zza(object, ++l10);
                    return zzir.zza(n10, n11, (int)by2);
                }
                object = new AssertionError;
                object();
                throw object;
            }
            byte by3 = zzip.zza(object, l10);
            return zzir.zza(n10, by3);
        }
        return zzir.zza(n10);
    }
    ...
    public final int zza(int n10, byte[] byArray, int n11, int n12) {
        ...
        if (n15 >= 0) {
            ...
            while (true) {
                ...
                if (n14 < n19) {
                    if (n13 < n16) {
                        return zziv.zza(object, n14, l12, n13);
                    }
                    n13 += -2;
                    l10 = l12 + l11;
                    by2 = zzip.zza(object, l12);
                ...
                n13 += -3;
                l10 = l12 + l11;
                n15 = zzip.zza(object, l12);
                if (n15 > by3) break;
                n14 <<= 28;
                if ((n14 = n14 + (n15 += 112) >> 30) != 0) break;
                l15 = l10 + l11;
                by2 = zzip.zza(object, l10);
                if (by2 > by3) break;
                l12 = l15 + l11;
                n14 = zzip.zza(object, l15);
                if (n14 > by3) break;
            }
            return n18;
        }
                ...
                block17: {
                    block18: {
                        ...
                        block14: {
                                    ...
                                    block11: {
                                        ...
                                        block13: {
                                            ...
                                            block12: {
                                                ...
                                                zzip.zza(object, l11, (byte)n18);
                                                l19 = l16 + l10;
                                                by4 = n16 & 0x3F;
                                                n16 = 128;
                                                by4 = (byte)(by4 | n16);
                                                zzip.zza(object, l16, by4);
                                                l13 = l10;
                                                n20 = 128;
                                                f11 = 1.794E-43f;
                                                l14 = l19;
                                        ...
                                        zzip.zza(object, l11, (byte)l15);
                                        l11 = l23 + l10;
                                        l15 = n13 >>> 12 & 0x3F;
                                        n20 = 128;
                                        f11 = 1.794E-43f;
                                        byte by6 = (byte)(l15 | 0x80);
                                        zzip.zza(object, l23, by6);
                                        l16 = l11 + 1L;
                                        int n21 = n13 >>> 6;
                                        by6 = (byte)(n21 & 0x3F | n20);
                                        zzip.zza(object, l11, by6);
                                        l11 = 1L;
                                        d11 = Double.MIN_VALUE;
                                        l14 = l16 + l11;
                                        n13 = (byte)(n13 & 0x3F | n20);
                                        zzip.zza(object, l16, (byte)n13);
                                        n13 = n18;
                                    }
                                    n18 = n20;
                                    f10 = f11;
                            ...
                            void var7_12 = n19 + -1;
                            object2 = new zzis((int)var7_12, n15);
                            throw object2;
                        }
