...
RandomAccess {
    ...
    private zzge(int[] nArray, int n10) {
        this.zzb = nArray;
        this.zzc = n10;
    }
    ...
    public final boolean addAll(Collection object) {
        this.zzc();
        zzgg.zza(object);
        int n10 = object instanceof zzge;
        if (n10 == 0) {
        ...
        if (n12 >= n10) {
            ...
            nArray = ((zzge)object).zzb;
            int[] nArray2 = this.zzb;
            int n13 = this.zzc;
            int n14 = ((zzge)object).zzc;
    ...
    public final boolean equals(Object object) {
        ...
        object = (zzge)object;
        n10 = this.zzc;
        int n11 = ((zzge)object).zzc;
        if (n10 != n11) {
            return false;
        }
        object = ((zzge)object).zzb;
    ...
    public final /* synthetic */ zzgm zzb(int n10) {
        ...
        if (n10 >= n11) {
            ...
            int n12 = this.zzc;
            zzge zzge2 = new zzge(nArray, n12);
            return zzge2;
        }
