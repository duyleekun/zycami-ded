...
import com.google.android.gms.internal.mlkit_vision_common.zzc;
...
public final class zzd {
    public static int zza(int n10, int n11) {
        ...
        if (n10 >= 0) {
            ...
            object = zzc.zza("%s (%s) must be less than size (%s)", objectArray);
        } else {
            Object[] objectArray = new Object[n13];
            objectArray[0] = string2;
            objectArray[n12] = object = Integer.valueOf(n10);
            object = zzc.zza("%s (%s) must not be negative", objectArray);
        }
    ...
    private static String zza(int n10, int n11, String string2) {
        ...
        if (n10 < 0) {
            ...
            Integer n14 = n10;
            objectArray[n12] = n14;
            return zzc.zza("%s (%s) must not be negative", objectArray);
        }
        if (n11 >= 0) {
            ...
            n15 = n11;
            objectArray[n13] = n15;
            return zzc.zza("%s (%s) must not be greater than size (%s)", objectArray);
        }
        StringBuilder stringBuilder = new StringBuilder(26);
        stringBuilder.append("negative size: ");
        stringBuilder.append(n11);
    ...
    public static void zza(int n10, int n11, int n12) {
        ...
        if (n10 >= 0 && n10 <= n12) {
            if (n11 >= 0 && n11 <= n12) {
                ...
                object = zzc.zza("end index (%s) must not be less than start index (%s)", objectArray);
            } else {
                object = zzd.zza(n11, n12, "end index");
            }
        } else {
            String string2 = "start index";
            object = zzd.zza(n10, n12, string2);
        }
        IndexOutOfBoundsException indexOutOfBoundsException = new IndexOutOfBoundsException((String)object);
        throw indexOutOfBoundsException;
    }
    ...
    public static int zzb(int n10, int n11) {
        ...
        String string2 = zzd.zza(n10, n11, "index");
