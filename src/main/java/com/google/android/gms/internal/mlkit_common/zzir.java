...
public final class zzir {
    ...
    static {
        ...
        zziq2 = bl2 && !(bl2 = zzen.zza()) ? new zziv() : new zzit();
        zza = zziq2;
    }
    ...
    public static boolean zza(byte[] byArray) {
        ...
        return zziq2.zza(byArray, 0, n10);
    }
    ...
    public static /* synthetic */ int zzb(byte[] byArray, int n10, int n11) {
        return zzir.zzc(byArray, n10, n11);
    }
        ...
        if ((n11 -= n10) != 0) {
            ...
            if (n11 != n13) {
                ...
                if (n11 == n14) {
                    ...
                    return zzir.zzb(n12, n11, (int)by2);
                }
