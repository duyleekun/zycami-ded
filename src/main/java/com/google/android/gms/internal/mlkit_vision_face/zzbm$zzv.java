...
import com.google.android.gms.internal.mlkit_vision_face.zzbm$zzv$zza;
...
public final class zzbm$zzv
extends zzgd
implements zzhn {
    private static final zzbm$zzv zzg;
    ...
    static {
        zzbm$zzv zzbm$zzv;
        zzg = zzbm$zzv = new zzbm$zzv();
        zzgd.zza(zzbm$zzv.class, zzbm$zzv);
    }

    private zzbm$zzv() {
    }

    public static /* synthetic */ zzbm$zzv zza() {
        return zzg;
    }
