...
import com.google.android.gms.internal.mlkit_vision_common.zzdh;
import com.google.android.gms.internal.mlkit_vision_common.zzdi;
import com.google.android.gms.internal.mlkit_vision_common.zzdj;
import com.google.android.gms.internal.mlkit_vision_common.zzdl;
...
import com.google.android.gms.internal.mlkit_vision_common.zzds;
...
Iterable {
    public static final zzdf zza;
    private static final zzdl zzb;
    private static final Comparator zzd;
    private int zzc = 0;

    static {
        byte[] byArray = zzem.zzb;
        Object object = new zzdp(byArray);
        zza = object;
        boolean bl2 = zzdd.zza();
        byArray = null;
        object = bl2 ? new zzds(null) : new zzdj(null);
        zzb = object;
        zzd = object = new zzdh();
    }
    ...
    public static zzdf zza(String object) {
        Charset charset = zzem.zza;
        object = ((String)object).getBytes(charset);
        zzdp zzdp2 = new zzdp((byte[])object);
        return zzdp2;
    }
    ...
    public static zzdn zzc(int n10) {
        zzdn zzdn2 = new zzdn(n10, null);
        return zzdn2;
    }
    ...
    public final String toString() {
        ...
        int n12 = this.zza();
        if (n12 <= (n10 = 50)) {
            object = zzgv.zza(this);
        } else {
            n12 = 47;
            object = String.valueOf(zzgv.zza(this.zza(0, n12)));
            string2 = "...";
    ...
    public abstract zzdf zza(int var1, int var2);

    public abstract String zza(Charset var1);

    public abstract void zza(zzdg var1);
