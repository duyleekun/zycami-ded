...
implements Runnable {
    ...
    public zziu(zzjb zzjb2, AtomicReference atomicReference, String string2, String string3, String string4, zzp zzp2, boolean bl2) {
        this.zzf = zzjb2;
        ...
        synchronized (var1_1) {
            block12: {
                ...
                if (var3_4 == null) {
                    ...
                    var3_4 = var3_4.zzat();
                    var3_4 = var3_4.zzb();
                    var4_7 = "(legacy) Failed to get user properties; not connected to service";
                    var5_11 = this.zzb;
                    var6_15 = this.zzc;
                ...
                ** GOTO lbl-1000
                {
                    ...
                    catch (RemoteException var3_5) {}
                    {
                        ...
                        var4_10 = var4_10.zzb();
                        var5_14 = "(legacy) Failed to get user properties; remote exception";
                        var6_18 = this.zzb;
...
lbl-1000:
...

                {
                    ...
                    if (var7_19) {
                        ...
                        var8_20 = this.zze;
                        var9_22 = this.zzd;
                        var3_4 = var3_4.zzo(var5_12, var6_16, var8_20, var9_22);
                        var4_8.set(var3_4);
                    } else {
                        var4_9 = this.zza;
                        var5_13 = this.zzb;
                        var6_17 = this.zzc;
                        var8_21 = this.zze;
                        var3_4 = var3_4.zzp(null, var5_13, var6_17, var8_21);
                        var4_9.set(var3_4);
                    }
                    var3_4 = this.zzf;
