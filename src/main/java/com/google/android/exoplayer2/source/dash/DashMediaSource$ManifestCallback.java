...
public final class DashMediaSource$ManifestCallback
implements Loader$Callback {
    ...
    public /* synthetic */ DashMediaSource$ManifestCallback(DashMediaSource dashMediaSource, DashMediaSource$1 dashMediaSource$1) {
    ...
    public void onLoadCompleted(ParsingLoadable parsingLoadable, long l10, long l11) {
        this.this$0.onManifestLoadCompleted(parsingLoadable, l10, l11);
    }
    ...
    public Loader$LoadErrorAction onLoadError(ParsingLoadable parsingLoadable, long l10, long l11, IOException iOException, int n10) {
        return this.this$0.onManifestLoadError(parsingLoadable, l10, l11, iOException, n10);
    }
}
