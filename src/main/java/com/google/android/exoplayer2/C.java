...
public final class C {
    ...
    public static final int BUFFER_FLAG_HAS_SUPPLEMENTAL_DATA = 0x10000000;
    public static final int BUFFER_FLAG_KEY_FRAME = 1;
    public static final int BUFFER_FLAG_LAST_SAMPLE = 0x20000000;
    ...
    public static final int INDEX_UNSET = 255;
    public static final String ISO88591_NAME = "ISO-8859-1";
    public static final String LANGUAGE_UNDETERMINED = "und";
    public static final int LENGTH_UNSET = 255;
    ...
    public static final int PERCENTAGE_UNSET = 255;
    public static final UUID PLAYREADY_UUID;
    public static final int POSITION_UNSET = 255;
    public static final int PRIORITY_DOWNLOAD = 64536;
    ...
    public static final int RESULT_BUFFER_READ = 252;
    public static final int RESULT_END_OF_INPUT = 255;
    public static final int RESULT_FORMAT_READ = 251;
    public static final int RESULT_MAX_LENGTH_EXCEEDED = 254;
    public static final int RESULT_NOTHING_READ = 253;
    ...
    public static final int TRACK_TYPE_UNKNOWN = 255;
    ...
    public static final int VIDEO_OUTPUT_MODE_NONE = 255;
    ...
    static {
        UUID uUID;
        long l10 = 0L;
        UUID_NIL = uUID = new UUID(l10, l10);
        COMMON_PSSH_UUID = uUID = new UUID(1186680826959645954L, -5988876978535335093L);
        CLEARKEY_UUID = uUID = new UUID(-2129748144642739255L, 8654423357094679310L);
        WIDEVINE_UUID = uUID = new UUID(-1301668207276963122L, -6645017420763422227L);
        PLAYREADY_UUID = uUID = new UUID(-7348484286925749626L, -6083546864340672619L);
    }
    ...
    public static int generateAudioSessionIdV21(Context context) {
        ...
        int n10 = (context = (AudioManager)context.getSystemService(string2)) == null ? -1 : context.generateAudioSessionId();
        return n10;
    }

    public static String getFormatSupportString(int n10) {
        if (n10 != 0) {
            int n11 = 1;
            if (n10 != n11) {
                n11 = 2;
    ...
    public static long msToUs(long l10) {
        long l11;
        long l12 = -9223372036854775807L;
        long l13 = l10 - l12;
        Object object = l13 == 0L ? 0 : (l13 < 0L ? -1 : 1);
        if (object != false && (object = (l11 = l10 - (l12 = Long.MIN_VALUE)) == 0L ? 0 : (l11 < 0L ? -1 : 1)) != false) {
            l12 = 1000L;
            l10 *= l12;
        }
        return l10;
    ...
    public static long usToMs(long l10) {
        long l11;
        long l12 = -9223372036854775807L;
        long l13 = l10 - l12;
        Object object = l13 == 0L ? 0 : (l13 < 0L ? -1 : 1);
