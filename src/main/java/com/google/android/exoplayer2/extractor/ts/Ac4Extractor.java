...
import d.h.a.a.h0.i.b;

public final class Ac4Extractor
implements Extractor {
    public static final ExtractorsFactory FACTORY = b.a;
    ...
    public Ac4Extractor() {
        Object object = new Ac4Reader();
        this.reader = object;
        this.sampleData = object = new ParsableByteArray(16384);
    }

    public static /* synthetic */ Extractor[] a() {
        Extractor[] extractorArray = new Extractor[1];
        Ac4Extractor ac4Extractor = new Ac4Extractor();
        extractorArray[0] = ac4Extractor;
    ...
    public void init(ExtractorOutput extractorOutput) {
        ...
        ((Ac4Reader)object).createTracks(extractorOutput, tsPayloadReader$TrackIdGenerator);
    ...
    public int read(ExtractorInput object, PositionHolder object2) {
        ...
        int n12 = object.read((byte[])object2, 0, n11 = 16384);
        if (n12 == (n10 = -1)) {
            return n10;
        }
        ...
        if (n12 == 0) {
            ...
            long l10 = 0L;
            n10 = 4;
            ((Ac4Reader)object).packetStarted(l10, n10);
            n12 = 1;
            this.startedPacket = n12;
        }
        object = this.reader;
        object2 = this.sampleData;
        ((Ac4Reader)object).consume((ParsableByteArray)object2);
        return 0;
    }
        ...
        while (true) {
            ...
            if (n12 != n13) {
                ...
                while (true) {
                    ...
                    extractorInput.peekFully(byArray2, 0, 7);
                    parsableByteArray.setPosition(0);
                    n13 = parsableByteArray.readUnsignedShort();
                    int n14 = 44096;
                    if (n13 != n14 && n13 != (n14 = 44097)) {
                        extractorInput.resetPeekPosition();
                        n10 = ++n12 - n11;
                        n13 = 8192;
                        if (n10 >= n13) {
                    ...
                    byte[] byArray3 = parsableByteArray.getData();
                    n13 = Ac4Util.parseAc4SyncframeSize(byArray3, n13);
                    if (n13 == (n14 = -1)) {
                        return false;
                    }
                    extractorInput.advancePeekPosition(n13 += -7);
                }
            }
