...
public abstract class Atom {
    ...
    public static String getAtomTypeString(int n10) {
        char c10 = (char)(n10 >> 24 & 0xFF);
        char c11 = (char)(n10 >> 16 & 0xFF);
        char c12 = (char)(n10 >> 8 & 0xFF);
        n10 = (char)(n10 & 0xFF);
    ...
    public static int parseFullAtomFlags(int n10) {
        return n10 & 0xFFFFFF;
    }

    public static int parseFullAtomVersion(int n10) {
        return n10 >> 24 & 0xFF;
    }
