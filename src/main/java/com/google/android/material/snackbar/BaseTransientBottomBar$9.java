...
public class BaseTransientBottomBar$9
implements ValueAnimator.AnimatorUpdateListener {
    private int previousAnimatedIntValue;
    public final /* synthetic */ BaseTransientBottomBar this$0;
    public final /* synthetic */ int val$translationYBottom;

    public BaseTransientBottomBar$9(BaseTransientBottomBar baseTransientBottomBar, int n10) {
        this.this$0 = baseTransientBottomBar;
        this.val$translationYBottom = n10;
