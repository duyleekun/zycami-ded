...
implements Iterator {
    ...
    public TreeMultiset$3(TreeMultiset object) {
        this.this$0 = object;
        this.current = object = TreeMultiset.access$1600((TreeMultiset)object);
        this.prevEntry = null;
    }
    ...
    public Multiset$Entry next() {
        ...
        if (bl2) {
            ...
            treeMultiset$AvlNode2 = TreeMultiset$AvlNode.access$900(this.current);
            if (treeMultiset$AvlNode2 == (treeMultiset$AvlNode = TreeMultiset.access$1500(this.this$0))) {
                treeMultiset$AvlNode2 = null;
                this.current = null;
            } else {
                this.current = treeMultiset$AvlNode2 = TreeMultiset$AvlNode.access$900(this.current);
            }
            return object;
        }
