...
public class Traverser$GraphTraverser$3
implements Iterable {
    public final /* synthetic */ Traverser$GraphTraverser this$0;
    public final /* synthetic */ Iterable val$startNodes;

    public Traverser$GraphTraverser$3(Traverser$GraphTraverser traverser$GraphTraverser, Iterable iterable) {
    ...
    public Iterator iterator() {
        ...
        Traverser$Order traverser$Order = Traverser$Order.POSTORDER;
