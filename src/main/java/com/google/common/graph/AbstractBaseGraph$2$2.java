...
public class AbstractBaseGraph$2$2
implements Function {
    public final /* synthetic */ AbstractBaseGraph$2 this$1;

    public AbstractBaseGraph$2$2(AbstractBaseGraph$2 abstractBaseGraph$2) {
        this.this$1 = abstractBaseGraph$2;
    }

    public EndpointPair apply(Object object) {
        return EndpointPair.ordered(this.this$1.node, object);
    }
}
