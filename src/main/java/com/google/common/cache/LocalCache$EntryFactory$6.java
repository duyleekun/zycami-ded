...
public final class LocalCache$EntryFactory$6
extends LocalCache$EntryFactory {
    ...
    public ReferenceEntry newEntry(LocalCache$Segment object, Object object2, int n10, ReferenceEntry referenceEntry) {
        ...
        LocalCache$WeakAccessEntry localCache$WeakAccessEntry = new LocalCache$WeakAccessEntry((ReferenceQueue)object, object2, n10, referenceEntry);
