...
implements DescriptorProtos$EnumValueOptionsOrBuilder {
    ...
    private DescriptorProtos$EnumValueOptions$Builder(GeneratedMessageV3$BuilderParent object) {
        super((GeneratedMessageV3$BuilderParent)object);
        this.uninterpretedOption_ = object = Collections.emptyList();
        this.maybeForceBuilderInitialization();
    }

    public /* synthetic */ DescriptorProtos$EnumValueOptions$Builder(GeneratedMessageV3$BuilderParent generatedMessageV3$BuilderParent, DescriptorProtos$1 descriptorProtos$1) {
    ...
    public DescriptorProtos$EnumValueOptions$Builder addExtension(GeneratedMessage$GeneratedExtension generatedMessage$GeneratedExtension, Object object) {
        return (DescriptorProtos$EnumValueOptions$Builder)super.addExtension(generatedMessage$GeneratedExtension, object);
    }

    public DescriptorProtos$EnumValueOptions$Builder addRepeatedField(Descriptors$FieldDescriptor descriptors$FieldDescriptor, Object object) {
        return (DescriptorProtos$EnumValueOptions$Builder)super.addRepeatedField(descriptors$FieldDescriptor, object);
    }

    public DescriptorProtos$EnumValueOptions$Builder addUninterpretedOption(int n10, DescriptorProtos$UninterpretedOption$Builder descriptorProtos$UninterpretedOptionOrBuilder) {
        Object object = this.uninterpretedOptionBuilder_;
        if (object == null) {
            this.ensureUninterpretedOptionIsMutable();
            object = this.uninterpretedOption_;
    ...
    public DescriptorProtos$EnumValueOptions$Builder addUninterpretedOption(int n10, DescriptorProtos$UninterpretedOption descriptorProtos$UninterpretedOption) {
        Object object = this.uninterpretedOptionBuilder_;
        if (object == null) {
    ...
    public DescriptorProtos$EnumValueOptions build() {
        ...
        boolean bl2 = descriptorProtos$EnumValueOptions.isInitialized();
        if (bl2) {
            return descriptorProtos$EnumValueOptions;
        }
        throw AbstractMessage$Builder.newUninitializedMessageException(descriptorProtos$EnumValueOptions);
    }
    ...
    public DescriptorProtos$EnumValueOptions buildPartial() {
        ...
        if ((n10 &= n11) != 0) {
            ...
            DescriptorProtos$EnumValueOptions.access$22502(descriptorProtos$EnumValueOptions, n10 != 0);
        } else {
            n11 = 0;
        }
        ...
        if (list == null) {
            ...
            DescriptorProtos$EnumValueOptions.access$22602(descriptorProtos$EnumValueOptions, list);
        } else {
            list = ((RepeatedFieldBuilderV3)((Object)list)).build();
            DescriptorProtos$EnumValueOptions.access$22602(descriptorProtos$EnumValueOptions, list);
        }
        DescriptorProtos$EnumValueOptions.access$22702(descriptorProtos$EnumValueOptions, n11);
        this.onBuilt();
        return descriptorProtos$EnumValueOptions;
    }
    ...
    public DescriptorProtos$EnumValueOptions$Builder clearExtension(GeneratedMessage$GeneratedExtension generatedMessage$GeneratedExtension) {
        return (DescriptorProtos$EnumValueOptions$Builder)super.clearExtension(generatedMessage$GeneratedExtension);
    }

    public DescriptorProtos$EnumValueOptions$Builder clearField(Descriptors$FieldDescriptor descriptors$FieldDescriptor) {
        return (DescriptorProtos$EnumValueOptions$Builder)super.clearField(descriptors$FieldDescriptor);
    }

    public DescriptorProtos$EnumValueOptions$Builder clearOneof(Descriptors$OneofDescriptor descriptors$OneofDescriptor) {
        return (DescriptorProtos$EnumValueOptions$Builder)super.clearOneof(descriptors$OneofDescriptor);
    }
     ...
     */
    public DescriptorProtos$EnumValueOptions$Builder mergeFrom(CodedInputStream object, ExtensionRegistryLite object2) {
        void var1_6;
        Object object3;
        block7: {
            object3 = null;
            Parser parser = DescriptorProtos$EnumValueOptions.PARSER;
            object = parser.parsePartialFrom((CodedInputStream)object, (ExtensionRegistryLite)object2);
            object = (DescriptorProtos$EnumValueOptions)object;
            if (object == null) break block7;
            this.mergeFrom((DescriptorProtos$EnumValueOptions)object);
        }
        return this;
        {
            ...
            catch (InvalidProtocolBufferException invalidProtocolBufferException) {}
            {
                ...
                object2 = (DescriptorProtos$EnumValueOptions)object2;
            }
            try {
        ...
        if (object3 != null) {
            this.mergeFrom((DescriptorProtos$EnumValueOptions)object3);
        }
        throw var1_6;
    }

    public DescriptorProtos$EnumValueOptions$Builder mergeFrom(DescriptorProtos$EnumValueOptions messageLite) {
        Object object = DescriptorProtos$EnumValueOptions.getDefaultInstance();
        if (messageLite == object) {
            return this;
        }
        boolean n10 = ((DescriptorProtos$EnumValueOptions)messageLite).hasDeprecated();
        if (n10) {
            boolean bl2 = ((DescriptorProtos$EnumValueOptions)messageLite).getDeprecated();
            this.setDeprecated(bl2);
        }
        if ((object = this.uninterpretedOptionBuilder_) == null) {
            object = DescriptorProtos$EnumValueOptions.access$22600((DescriptorProtos$EnumValueOptions)messageLite);
            ...
            if (!bl3) {
                ...
                if (bl4) {
                    int n11;
                    this.uninterpretedOption_ = object = DescriptorProtos$EnumValueOptions.access$22600((DescriptorProtos$EnumValueOptions)messageLite);
                    this.bitField0_ = n11 = this.bitField0_ & 0xFFFFFFFD;
                } else {
                    this.ensureUninterpretedOptionIsMutable();
                    object = this.uninterpretedOption_;
                    List list = DescriptorProtos$EnumValueOptions.access$22600((DescriptorProtos$EnumValueOptions)messageLite);
                    object.addAll(list);
                }
                this.onChanged();
            }
            ...
            if (!bl5) {
                ...
                if (bl6) {
                    ...
                    this.uninterpretedOption_ = list = DescriptorProtos$EnumValueOptions.access$22600((DescriptorProtos$EnumValueOptions)messageLite);
    ...
    public DescriptorProtos$EnumValueOptions$Builder mergeFrom(Message message) {
        boolean bl2 = message instanceof DescriptorProtos$EnumValueOptions;
        if (bl2) {
            message = (DescriptorProtos$EnumValueOptions)message;
    ...
    public DescriptorProtos$EnumValueOptions$Builder removeUninterpretedOption(int n10) {
        Object object = this.uninterpretedOptionBuilder_;
        if (object == null) {
            this.ensureUninterpretedOptionIsMutable();
            object = this.uninterpretedOption_;
    ...
    public DescriptorProtos$EnumValueOptions$Builder setExtension(GeneratedMessage$GeneratedExtension generatedMessage$GeneratedExtension, int n10, Object object) {
        return (DescriptorProtos$EnumValueOptions$Builder)super.setExtension(generatedMessage$GeneratedExtension, n10, object);
    }

    public DescriptorProtos$EnumValueOptions$Builder setExtension(GeneratedMessage$GeneratedExtension generatedMessage$GeneratedExtension, Object object) {
        return (DescriptorProtos$EnumValueOptions$Builder)super.setExtension(generatedMessage$GeneratedExtension, object);
    }

    public DescriptorProtos$EnumValueOptions$Builder setField(Descriptors$FieldDescriptor descriptors$FieldDescriptor, Object object) {
        return (DescriptorProtos$EnumValueOptions$Builder)super.setField(descriptors$FieldDescriptor, object);
    }

    public DescriptorProtos$EnumValueOptions$Builder setRepeatedField(Descriptors$FieldDescriptor descriptors$FieldDescriptor, int n10, Object object) {
        return (DescriptorProtos$EnumValueOptions$Builder)super.setRepeatedField(descriptors$FieldDescriptor, n10, object);
    }

    public DescriptorProtos$EnumValueOptions$Builder setUninterpretedOption(int n10, DescriptorProtos$UninterpretedOption$Builder descriptorProtos$UninterpretedOptionOrBuilder) {
        Object object = this.uninterpretedOptionBuilder_;
        if (object == null) {
            this.ensureUninterpretedOptionIsMutable();
            object = this.uninterpretedOption_;
    ...
    public DescriptorProtos$EnumValueOptions$Builder setUninterpretedOption(int n10, DescriptorProtos$UninterpretedOption descriptorProtos$UninterpretedOption) {
        Object object = this.uninterpretedOptionBuilder_;
        if (object == null) {
            Objects.requireNonNull(descriptorProtos$UninterpretedOption);
            this.ensureUninterpretedOptionIsMutable();
