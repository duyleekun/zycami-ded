...
public class MapField$MutatabilityAwareMap$MutatabilityAwareCollection
implements Collection {
    private final Collection delegate;
    private final MutabilityOracle mutabilityOracle;

    public MapField$MutatabilityAwareMap$MutatabilityAwareCollection(MutabilityOracle mutabilityOracle, Collection collection) {
