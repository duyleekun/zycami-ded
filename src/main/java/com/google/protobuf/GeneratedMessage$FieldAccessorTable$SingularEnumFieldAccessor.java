...
public final class GeneratedMessage$FieldAccessorTable$SingularEnumFieldAccessor
extends GeneratedMessage$FieldAccessorTable$SingularFieldAccessor {
    ...
    public GeneratedMessage$FieldAccessorTable$SingularEnumFieldAccessor(Descriptors$FieldDescriptor object, String classArray, Class object2, Class clazz, String object3) {
        ...
        if (bl2) {
            ...
            this.getValueMethod = object = GeneratedMessage.access$1100((Class)object2, (String)object, classArray2);
            object = new StringBuilder();
            ((StringBuilder)object).append((String)object3);
            ((StringBuilder)object).append((String)classArray);
            ((StringBuilder)object).append((String)object4);
            object = ((StringBuilder)object).toString();
            object2 = new Class[]{};
            this.getValueMethodBuilder = object = GeneratedMessage.access$1100(clazz, (String)object, object2);
            object = new StringBuilder();
            ...
            this.setValueMethod = object = GeneratedMessage.access$1100(clazz, (String)object, classArray);
        }
    }

    public Object get(GeneratedMessage$Builder object) {
        boolean bl2 = this.supportUnknownEnumValue;
        Object[] objectArray = null;
        if (bl2) {
            Method method = this.getValueMethodBuilder;
            objectArray = new Object[]{};
            int n10 = (Integer)GeneratedMessage.access$1200(method, object, objectArray);
            return this.enumDescriptor.findValueByNumberCreatingIfUnknown(n10);
        }
        Method method = this.getValueDescriptorMethod;
        object = super.get((GeneratedMessage$Builder)object);
        objectArray = new Object[]{};
        return GeneratedMessage.access$1200(method, object, objectArray);
    }

    public Object get(GeneratedMessage object) {
        boolean bl2 = this.supportUnknownEnumValue;
        Object[] objectArray = null;
        if (bl2) {
        ...
        Method method = this.getValueDescriptorMethod;
        object = super.get((GeneratedMessage)object);
        objectArray = new Object[]{};
        return GeneratedMessage.access$1200(method, object, objectArray);
    }
