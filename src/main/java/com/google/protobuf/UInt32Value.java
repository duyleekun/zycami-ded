...
implements UInt32ValueOrBuilder {
    ...
    static {
        Object object = new UInt32Value();
        DEFAULT_INSTANCE = object;
        PARSER = object = new UInt32Value$1();
    }
     ...
     */
    private UInt32Value(CodedInputStream object, ExtensionRegistryLite object2) {
        this();
                ...
                try {
                    ...
                    if (n10 != 0) {
                        ...
                        if (n10 != n11) {
                            ...
                            this.value_ = n10 = ((CodedInputStream)object).readUInt32();
                            continue;
                        }
                    }
                    bl2 = bl3;
    ...
    public /* synthetic */ UInt32Value(CodedInputStream codedInputStream, ExtensionRegistryLite extensionRegistryLite, UInt32Value$1 uInt32Value$1) {
        this(codedInputStream, extensionRegistryLite);
    }

    private UInt32Value(GeneratedMessageV3$Builder generatedMessageV3$Builder) {
        super(generatedMessageV3$Builder);
    }

    public /* synthetic */ UInt32Value(GeneratedMessageV3$Builder generatedMessageV3$Builder, UInt32Value$1 uInt32Value$1) {
        this(generatedMessageV3$Builder);
    }

    public static /* synthetic */ int access$302(UInt32Value uInt32Value, int n10) {
        uInt32Value.value_ = n10;
        return n10;
    }
    ...
    public static UInt32Value$Builder newBuilder(UInt32Value uInt32Value) {
        return ((UInt32Value$Builder)DEFAULT_INSTANCE.toBuilder()).mergeFrom(uInt32Value);
    }

    public static UInt32Value of(int n10) {
        return UInt32Value.newBuilder().setValue(n10).build();
    }
    ...
    public static UInt32Value parseFrom(byte[] byArray) {
        return (UInt32Value)PARSER.parseFrom(byArray);
    }

    public static UInt32Value parseFrom(byte[] byArray, ExtensionRegistryLite extensionRegistryLite) {
        return (UInt32Value)PARSER.parseFrom(byArray, extensionRegistryLite);
    }
    ...
    public boolean equals(Object object) {
        ...
        int n11 = object instanceof UInt32Value;
        if (n11 == 0) {
            return super.equals(object);
        }
        object = (UInt32Value)object;
        n11 = this.getValue();
        if (n11 != (n10 = ((UInt32Value)object).getValue())) {
            return false;
        }
    ...
    public int getSerializedSize() {
        ...
        if (n11 != 0) {
            int n12 = 1;
            n11 = CodedOutputStream.computeUInt32Size(n12, n11);
            n10 = 0 + n11;
        }
    ...
    public int hashCode() {
        ...
        int n11 = UInt32Value.getDescriptor().hashCode();
        n10 = ((779 + n11) * 37 + 1) * 53;
        n11 = this.getValue();
        n10 = (n10 + n11) * 29;
    ...
    public UInt32Value$Builder newBuilderForType(GeneratedMessageV3$BuilderParent generatedMessageV3$BuilderParent) {
        UInt32Value$Builder uInt32Value$Builder = new UInt32Value$Builder(generatedMessageV3$BuilderParent, null);
        return uInt32Value$Builder;
    }

    public Object newInstance(GeneratedMessageV3$UnusedPrivateParameter object) {
        object = new UInt32Value();
        return object;
    }

    public UInt32Value$Builder toBuilder() {
        UInt32ValueOrBuilder uInt32ValueOrBuilder = DEFAULT_INSTANCE;
        if (this == uInt32ValueOrBuilder) {
            uInt32ValueOrBuilder = new UInt32Value$Builder(null);
        } else {
            uInt32ValueOrBuilder = new UInt32Value$Builder(null);
            uInt32ValueOrBuilder = ((UInt32Value$Builder)uInt32ValueOrBuilder).mergeFrom(this);
        }
        return uInt32ValueOrBuilder;
    }
    ...
    public void writeTo(CodedOutputStream codedOutputStream) {
        ...
        if (n10 != 0) {
            int n11 = 1;
            codedOutputStream.writeUInt32(n11, n10);
        }
