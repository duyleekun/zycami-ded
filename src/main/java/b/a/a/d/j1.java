...
implements Runnable {
    ...
    public /* synthetic */ j1(ZoomControl zoomControl, CallbackToFutureAdapter$Completer callbackToFutureAdapter$Completer, ZoomState zoomState) {
        this.a = zoomControl;
    ...
    public final void run() {
        ...
        zoomControl.f(callbackToFutureAdapter$Completer, zoomState);
    }
}
