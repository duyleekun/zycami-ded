...
public final class CompletableUsing$UsingObserver
...
b {
    ...
    public CompletableUsing$UsingObserver(d d10, Object object, g g10, boolean bl2) {
        super(object);
        this.downstream = d10;
        this.disposer = g10;
        this.eager = bl2;
    ...
    public void disposeResourceAfter() {
        CompletableUsing$UsingObserver completableUsing$UsingObserver = this.getAndSet(this);
        if (completableUsing$UsingObserver != this) {
            g g10 = this.disposer;
            try {
                g10.accept(completableUsing$UsingObserver);
            }
