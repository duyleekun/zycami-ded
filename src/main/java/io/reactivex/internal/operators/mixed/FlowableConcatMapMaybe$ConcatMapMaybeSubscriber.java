...
import io.reactivex.internal.operators.mixed.FlowableConcatMapMaybe$ConcatMapMaybeSubscriber$ConcatMapMaybeObserver;
...
public final class FlowableConcatMapMaybe$ConcatMapMaybeSubscriber
...
e {
    ...
    public final FlowableConcatMapMaybe$ConcatMapMaybeSubscriber$ConcatMapMaybeObserver inner;
    public Object item;
    ...
    public FlowableConcatMapMaybe$ConcatMapMaybeSubscriber(d object, o o10, int n10, ErrorMode errorMode) {
        ...
        this.inner = object = new FlowableConcatMapMaybe$ConcatMapMaybeSubscriber$ConcatMapMaybeObserver(this);
    ...
    public void cancel() {
        ...
        FlowableConcatMapMaybe$ConcatMapMaybeSubscriber$ConcatMapMaybeObserver flowableConcatMapMaybe$ConcatMapMaybeSubscriber$ConcatMapMaybeObserver = this.inner;
        flowableConcatMapMaybe$ConcatMapMaybeSubscriber$ConcatMapMaybeObserver.dispose();
        int n10 = this.getAndIncrement();
        if (n10 == 0) {
            this.queue.clear();
            n10 = 0;
            flowableConcatMapMaybe$ConcatMapMaybeSubscriber$ConcatMapMaybeObserver = null;
            this.item = null;
        }
    }
    ...
    public void onError(Throwable object) {
        ...
        if (bl2) {
            ...
            if (object == object2) {
                object = this.inner;
                ((FlowableConcatMapMaybe$ConcatMapMaybeSubscriber$ConcatMapMaybeObserver)object).dispose();
            }
            this.done = bl3 = true;
            this.drain();
        } else {
