...
import io.reactivex.internal.operators.mixed.ObservableConcatMapMaybe$ConcatMapMaybeMainObserver$ConcatMapMaybeObserver;
import io.reactivex.internal.util.AtomicThrowable;
import io.reactivex.internal.util.ErrorMode;
import java.util.concurrent.atomic.AtomicInteger;

public final class ObservableConcatMapMaybe$ConcatMapMaybeMainObserver
...
b {
    ...
    public final ObservableConcatMapMaybe$ConcatMapMaybeMainObserver$ConcatMapMaybeObserver inner;
    public Object item;
    ...
    public ObservableConcatMapMaybe$ConcatMapMaybeMainObserver(g0 object, o o10, int n10, ErrorMode errorMode) {
        this.downstream = object;
        this.mapper = o10;
        this.errorMode = errorMode;
        this.errors = object = new AtomicThrowable();
        this.inner = object = new ObservableConcatMapMaybe$ConcatMapMaybeMainObserver$ConcatMapMaybeObserver(this);
    ...
    public void dispose() {
        ...
        ObservableConcatMapMaybe$ConcatMapMaybeMainObserver$ConcatMapMaybeObserver observableConcatMapMaybe$ConcatMapMaybeMainObserver$ConcatMapMaybeObserver = this.inner;
        observableConcatMapMaybe$ConcatMapMaybeMainObserver$ConcatMapMaybeObserver.dispose();
        int n10 = this.getAndIncrement();
        if (n10 == 0) {
            this.queue.clear();
            n10 = 0;
            observableConcatMapMaybe$ConcatMapMaybeMainObserver$ConcatMapMaybeObserver = null;
            this.item = null;
        }
    }
    ...
    public void onError(Throwable object) {
        ...
        if (bl2) {
            ...
            if (object == object2) {
                object = this.inner;
                ((ObservableConcatMapMaybe$ConcatMapMaybeMainObserver$ConcatMapMaybeObserver)object).dispose();
            }
            this.done = bl3 = true;
            this.drain();
        } else {
