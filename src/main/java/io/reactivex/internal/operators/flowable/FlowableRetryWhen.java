...
import io.reactivex.internal.operators.flowable.FlowableRetryWhen$RetryWhenSubscriber;
...
extends a {
    ...
    public FlowableRetryWhen(j j10, o o10) {
        super(j10);
        this.c = o10;
    }
    ...
    public void m6(d object) {
        ...
        ((FlowableRepeatWhen$WhenReceiver)object3).subscriber = object4 = new FlowableRetryWhen$RetryWhenSubscriber(e10, a10, (e)object3);
