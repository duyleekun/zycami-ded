...
public final class ObservableRepeatWhen
extends a {
    public final o b;

    public ObservableRepeatWhen(e0 e02, o o10) {
        super(e02);
        this.b = o10;
    }
    ...
    public void K5(g0 g02) {
        ...
        object = (e0)object;
        e0 e02 = this.a;
        object2 = new ObservableRepeatWhen$RepeatWhenObserver(g02, c10, e02);
        g02.onSubscribe((b)object2);
        g02 = ((ObservableRepeatWhen$RepeatWhenObserver)object2).inner;
        object.subscribe(g02);
        ((ObservableRepeatWhen$RepeatWhenObserver)object2).subscribeNext();
    }
}
