...
import io.reactivex.internal.operators.observable.ObservableMergeWithSingle$MergeWithObserver$OtherObserver;
import io.reactivex.internal.util.AtomicThrowable;
import java.util.concurrent.atomic.AtomicInteger;
import java.util.concurrent.atomic.AtomicReference;

public final class ObservableMergeWithSingle$MergeWithObserver
...
b {
    ...
    public final ObservableMergeWithSingle$MergeWithObserver$OtherObserver otherObserver;
    public volatile int otherState;
    public volatile n queue;
    public Object singleItem;

    public ObservableMergeWithSingle$MergeWithObserver(g0 atomicReference) {
        this.downstream = atomicReference;
        this.mainDisposable = atomicReference = new AtomicReference();
        this.otherObserver = atomicReference = new ObservableMergeWithSingle$MergeWithObserver$OtherObserver(this);
    ...
    public void dispose() {
        ...
        ObservableMergeWithSingle$MergeWithObserver$OtherObserver observableMergeWithSingle$MergeWithObserver$OtherObserver = this.otherObserver;
        DisposableHelper.dispose(observableMergeWithSingle$MergeWithObserver$OtherObserver);
        int n10 = this.getAndIncrement();
        if (n10 == 0) {
            n10 = 0;
            observableMergeWithSingle$MergeWithObserver$OtherObserver = null;
            this.queue = null;
