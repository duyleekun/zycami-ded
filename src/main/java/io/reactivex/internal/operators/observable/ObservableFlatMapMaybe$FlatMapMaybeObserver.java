...
public final class ObservableFlatMapMaybe$FlatMapMaybeObserver
...
b {
    ...
    public ObservableFlatMapMaybe$FlatMapMaybeObserver(g0 atomicReference, o o10, boolean bl2) {
     ...
     */
    public void innerComplete(ObservableFlatMapMaybe$FlatMapMaybeObserver$InnerObserver object) {
        ...
        if (n10 == 0) {
            ...
            object = null;
            int n11 = 1;
            int n12 = this.compareAndSet(0, n11);
            if (n12 != 0) {
                AtomicInteger atomicInteger = this.active;
                n12 = atomicInteger.decrementAndGet();
                if (n12 == 0) {
                    n10 = n11;
                }
                object2 = (e.a.w0.f.a)this.queue.get();
                if (n10 != 0 && (object2 == null || (n10 = (int)(((e.a.w0.f.a)object2).isEmpty() ? 1 : 0)) != 0)) {
    ...
    public void innerError(ObservableFlatMapMaybe$FlatMapMaybeObserver$InnerObserver object, Throwable throwable) {
     ...
     */
    public void innerSuccess(ObservableFlatMapMaybe$FlatMapMaybeObserver$InnerObserver var1_1, Object var2_2) {
        var3_3 = this.set;
        var3_3.c((b)var1_1);
        var4_4 = this.get();
    ...
    public void onNext(Object object) {
        ...
        object2 = new ObservableFlatMapMaybe$FlatMapMaybeObserver$InnerObserver(this);
