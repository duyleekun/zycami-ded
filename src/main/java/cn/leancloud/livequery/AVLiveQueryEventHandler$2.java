...
public class AVLiveQueryEventHandler$2
implements Runnable {
    ...
    public AVLiveQueryEventHandler$2(AVLiveQueryEventHandler aVLiveQueryEventHandler, AVObject aVObject, List list) {
    ...
    public void run() {
        ...
        aVLiveQueryEventHandler.onObjectUpdated(aVObject, list);
    }
}
