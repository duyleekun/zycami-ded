...
public class AVConversationHolder$4
extends SignatureCallback {
    ...
    public AVConversationHolder$4(AVConversationHolder aVConversationHolder, int n10, List list) {
    ...
    public Signature computeSignature() {
        ...
        if (signatureFactory != null) {
            ...
            return signatureFactory.createBlacklistSignature(string2, string3, list, "conversation-unblock-clients");
        }
        return null;
    }
    ...
    public void onSignatureReady(Signature object, AVException object2) {
        if (object2 == null) {
            ...
            int n10 = Conversation$AVIMOperation.CONVERSATION_UNBLOCK_MEMBER.getCode();
            String string2 = this.this$0.session.getSelfPeerId();
            String string3 = this.this$0.conversationId;
