...
public class AVConversationHolder$7
extends AVConversationHolder$SimpleCallback {
    ...
    public AVConversationHolder$7(AVConversationHolder aVConversationHolder, AVIMConversationEventHandler aVIMConversationEventHandler, String string2, AVIMConversation aVIMConversation) {
    ...
    public void done() {
        ...
        aVIMConversationEventHandler.processEvent(50008, string2, null, aVIMConversation);
    }
}
