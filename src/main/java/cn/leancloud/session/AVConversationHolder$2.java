...
public class AVConversationHolder$2
extends SignatureCallback {
    ...
    public AVConversationHolder$2(AVConversationHolder aVConversationHolder, int n10, List list) {
    ...
    public Signature computeSignature() {
        ...
        if (signatureFactory != null) {
            ...
            return signatureFactory.createConversationSignature(string2, (String)object, list, "kick");
        }
        return null;
    }
    ...
    public void onSignatureReady(Signature object, AVException object2) {
        if (object2 == null) {
            ...
            int n10 = Conversation$AVIMOperation.CONVERSATION_RM_MEMBER.getCode();
