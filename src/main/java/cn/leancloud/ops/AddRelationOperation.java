...
public class AddRelationOperation
extends BaseOperation {
    public AddRelationOperation(String list, Object object) {
        String string2 = "AddRelation";
    ...
    public Object apply(Object object) {
        ...
        if (!bl2 && !(bl2 = object instanceof JSONArray)) {
            ...
            charSequence.append("cannot apply AddRelationOperation on non list attribute. targetValueType=");
    ...
    public ObjectFieldOperation mergeWithPrevious(ObjectFieldOperation object) {
        ...
        if (!bl2 && !(bl2 = object instanceof DeleteOperation)) {
            ...
            if (bl2) {
                Object object2 = this.value;
                object = ((AddRelationOperation)object).value;
