...
import cn.leancloud.core.StorageClient$29$1;
import cn.leancloud.core.StorageClient$QueryExecutor;
import e.a.v0.o;
import e.a.z;

public class StorageClient$29
implements StorageClient$QueryExecutor {
    ...
    public StorageClient$29(StorageClient storageClient, String string2, String string3, long l10) {
    ...
    public z executor() {
        ...
        object2 = new StorageClient$29$1(this);
