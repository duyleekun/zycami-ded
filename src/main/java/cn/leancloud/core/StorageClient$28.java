...
implements StorageClient$QueryExecutor {
    ...
    public StorageClient$28(StorageClient storageClient, AVUser aVUser, String string2, Map map, AVQuery$CachePolicy aVQuery$CachePolicy, String string3) {
    ...
    public z executor() {
        ...
        return storageClient.callRPC(aVUser, string2, map, bl2, (String)object);
    }
}
