...
extends Exception {
    ...
    public static final int OTHER_CAUSE = 255;
    ...
    public AVException(int n10, String string2) {
        super(string2);
        this.code = n10;
    }

    public AVException(String string2, Throwable throwable) {
        super(string2, throwable);
        int n10 = throwable instanceof AVException;
        if (n10 != 0) {
            throwable = (AVException)throwable;
            this.code = n10 = ((AVException)throwable).getCode();
        } else {
            this.code = n10 = 999;
        }
    }
    ...
    public AVException(Throwable throwable) {
        super(throwable);
        boolean bl2 = throwable instanceof AVException;
        if (bl2) {
            int n10;
            throwable = (AVException)throwable;
            this.code = n10 = ((AVException)throwable).getCode();
