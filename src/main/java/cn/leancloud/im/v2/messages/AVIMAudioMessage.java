...
extends AVIMFileMessage {
    ...
    public AVIMAudioMessage(String string2) {
        super(string2);
        this.setHasAdditionalMetaAttr(true);
    }
    ...
    public void parseAdditionalMetaData(Map map, JSONObject serializable) {
        if (map != null && serializable != null) {
            ...
            int n10 = (serializable = serializable.getJSONObject(string2)).containsKey(object = "format_name");
            if (n10 != 0) {
                object = serializable.getString((String)object);
                map.put(string2, object);
            }
            if (bl3 = serializable.containsKey(string2 = "duration")) {
            ...
            if (bl2 = serializable.containsKey(string2 = "FILE_SIZE")) {
                string2 = "size";
