...
import cn.sharesdk.tencent.qq.b$1;
import cn.sharesdk.tencent.qq.b$2;
...
extends cn.sharesdk.framework.authorize.c {
    ...
    private void a(HashMap object) {
        ...
        if (!bl2) {
            try {
                ...
                object4 = c.a((Platform)object4);
                object4 = ((c)object4).c(string2);
    ...
    public void onReceivedSslError(WebView object, SslErrorHandler object2, SslError sslError) {
        ...
        if (n10 != 0) {
            ...
            object = new b$2(this, (SslErrorHandler)object2);
