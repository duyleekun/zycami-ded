...
public class ExifInterface$ByteOrderedDataInputStream
extends InputStream
implements DataInput {
    ...
    public ExifInterface$ByteOrderedDataInputStream(InputStream inputStream, ByteOrder byteOrder) {
        int n10;
        ...
        this.mPosition = 0;
        this.mDataInputStream.mark(n10);
        this.mByteOrder = byteOrder;
    }

    public ExifInterface$ByteOrderedDataInputStream(byte[] byArray) {
    ...
    public void seek(long l10) {
        ...
        if (object > 0) {
            ...
            DataInputStream dataInputStream = this.mDataInputStream;
            object = this.mLength;
            dataInputStream.mark((int)object);
        } else {
            long l13 = n10;
            l10 -= l13;
        }
