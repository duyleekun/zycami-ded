...
public class FocusMeteringControl$1
extends CameraCaptureCallback {
    ...
    public FocusMeteringControl$1(FocusMeteringControl focusMeteringControl, CallbackToFutureAdapter$Completer callbackToFutureAdapter$Completer) {
