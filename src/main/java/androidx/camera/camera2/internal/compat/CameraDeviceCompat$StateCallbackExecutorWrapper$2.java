...
public class CameraDeviceCompat$StateCallbackExecutorWrapper$2
implements Runnable {
    ...
    public CameraDeviceCompat$StateCallbackExecutorWrapper$2(CameraDeviceCompat$StateCallbackExecutorWrapper cameraDeviceCompat$StateCallbackExecutorWrapper, CameraDevice cameraDevice) {
