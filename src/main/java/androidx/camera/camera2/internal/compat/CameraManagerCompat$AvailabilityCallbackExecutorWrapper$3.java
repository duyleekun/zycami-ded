...
public class CameraManagerCompat$AvailabilityCallbackExecutorWrapper$3
implements Runnable {
    ...
    public CameraManagerCompat$AvailabilityCallbackExecutorWrapper$3(CameraManagerCompat$AvailabilityCallbackExecutorWrapper cameraManagerCompat$AvailabilityCallbackExecutorWrapper, String string2) {
