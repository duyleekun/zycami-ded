...
public class CameraCaptureSessionCompat$StateCallbackExecutorWrapper$4
implements Runnable {
    ...
    public CameraCaptureSessionCompat$StateCallbackExecutorWrapper$4(CameraCaptureSessionCompat$StateCallbackExecutorWrapper cameraCaptureSessionCompat$StateCallbackExecutorWrapper, CameraCaptureSession cameraCaptureSession) {
