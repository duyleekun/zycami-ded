...
public class CameraCaptureSessionCompat$StateCallbackExecutorWrapper$1
implements Runnable {
    ...
    public CameraCaptureSessionCompat$StateCallbackExecutorWrapper$1(CameraCaptureSessionCompat$StateCallbackExecutorWrapper stateCallbackExecutorWrapper, CameraCaptureSession cameraCaptureSession) {
