...
public class CameraCaptureSessionCompat$StateCallbackExecutorWrapper$6
implements Runnable {
    ...
    public CameraCaptureSessionCompat$StateCallbackExecutorWrapper$6(CameraCaptureSessionCompat$StateCallbackExecutorWrapper cameraCaptureSessionCompat$StateCallbackExecutorWrapper, CameraCaptureSession cameraCaptureSession) {
