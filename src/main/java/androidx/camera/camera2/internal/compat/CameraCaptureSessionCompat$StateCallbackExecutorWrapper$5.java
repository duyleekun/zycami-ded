...
public class CameraCaptureSessionCompat$StateCallbackExecutorWrapper$5
implements Runnable {
    ...
    public CameraCaptureSessionCompat$StateCallbackExecutorWrapper$5(CameraCaptureSessionCompat$StateCallbackExecutorWrapper cameraCaptureSessionCompat$StateCallbackExecutorWrapper, CameraCaptureSession cameraCaptureSession) {
