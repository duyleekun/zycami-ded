...
import androidx.transition.FragmentTransitionSupport$1;
import androidx.transition.FragmentTransitionSupport$2;
import androidx.transition.FragmentTransitionSupport$3;
import androidx.transition.FragmentTransitionSupport$4;
import androidx.transition.FragmentTransitionSupport$5;
import androidx.transition.FragmentTransitionSupport$6;
...
extends FragmentTransitionImpl {
    private static boolean hasSimpleTarget(Transition object) {
        ...
        if (bl3 && (bl3 = FragmentTransitionImpl.isNullOrEmpty(list = ((Transition)object).getTargetNames())) && (bl2 = FragmentTransitionImpl.isNullOrEmpty((List)(object = ((Transition)object).getTargetTypes())))) {
            bl2 = false;
            object = null;
        } else {
            bl2 = true;
    ...
    public void addTargets(Object object, ArrayList arrayList) {
        block4: {
            ...
            block3: {
                ...
                n11 = ((TransitionSet)object).getTransitionCount();
                for (n10 = 0; n10 < n11; ++n10) {
                    Transition transition = ((TransitionSet)object).getTransitionAt(n10);
                    this.addTargets(transition, arrayList);
                }
                break block4;
            }
            n11 = FragmentTransitionSupport.hasSimpleTarget((Transition)object);
            if (n11 != 0 || (n11 = (int)(FragmentTransitionImpl.isNullOrEmpty(list = ((Transition)object).getTargets()) ? 1 : 0)) == 0) break block4;
            n11 = arrayList.size();
            while (n10 < n11) {
    ...
    public Object mergeTransitionsInSequence(Object object, Object object2, Object object3) {
        ...
        if (object != null && object2 != null) {
            ...
            int n10 = 1;
            object = ((TransitionSet)object).setOrdering(n10);
        } else if (object == null) {
    ...
    public void replaceTargets(Object object, ArrayList arrayList, ArrayList arrayList2) {
        block6: {
            ...
            block5: {
                ...
                object = (TransitionSet)object;
                n13 = ((TransitionSet)object).getTransitionCount();
                for (n12 = 0; n12 < n13; ++n12) {
                    Transition transition = ((TransitionSet)object).getTransitionAt(n12);
                    this.replaceTargets(transition, arrayList, arrayList2);
                }
                break block6;
            }
            n13 = FragmentTransitionSupport.hasSimpleTarget((Transition)object);
            if (n13 != 0 || (n11 = (list = ((Transition)object).getTargets()).size()) != (n10 = arrayList.size()) || (n13 = (int)(list.containsAll(arrayList) ? 1 : 0)) == 0) break block6;
            if (arrayList2 == null) {
                n13 = 0;
                list = null;
            } else {
    ...
    public void scheduleHideFragmentView(Object object, View view, ArrayList arrayList) {
        object = (Transition)object;
        FragmentTransitionSupport$2 fragmentTransitionSupport$2 = new FragmentTransitionSupport$2(this, view, arrayList);
        ((Transition)object).addListener(fragmentTransitionSupport$2);
    }
    ...
    public void scheduleRemoveTargets(Object object, Object object2, ArrayList arrayList, Object object3, ArrayList arrayList2, Object object4, ArrayList arrayList3) {
        ...
        FragmentTransitionSupport$3 fragmentTransitionSupport$3 = new FragmentTransitionSupport$3(this, object2, arrayList, object3, arrayList2, object4, arrayList3);
        ((Transition)object5).addListener(fragmentTransitionSupport$3);
    }

    public void setEpicenter(Object object, Rect rect) {
        if (object != null) {
            object = (Transition)object;
            FragmentTransitionSupport$6 fragmentTransitionSupport$6 = new FragmentTransitionSupport$6(this, rect);
            ((Transition)object).setEpicenterCallback(fragmentTransitionSupport$6);
        }
    }
    ...
    public void setEpicenter(Object object, View object2) {
        if (object2 != null) {
            ...
            object2 = new FragmentTransitionSupport$1(this, rect);
            ((Transition)object).setEpicenterCallback((Transition$EpicenterCallback)object2);
        }
    }
    ...
    public void setListenerForTransitionEnd(Fragment object, Object object2, CancellationSignal cancellationSignal, Runnable runnable) {
        object2 = (Transition)object2;
        object = new FragmentTransitionSupport$4(this, (Transition)object2);
        cancellationSignal.setOnCancelListener((CancellationSignal$OnCancelListener)object);
        object = new FragmentTransitionSupport$5(this, runnable);
        ((Transition)object2).addListener((Transition$TransitionListener)object);
    }
