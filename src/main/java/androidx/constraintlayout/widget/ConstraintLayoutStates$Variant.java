    ...
    public ConstraintLayoutStates$Variant(Context context, XmlPullParser xmlPullParser) {
        ...
        for (int i10 = 0; i10 < n10; ++i10) {
            ...
            if (n12 == (n11 = R$styleable.Variant_constraints)) {
                ...
                object = "layout";
                n12 = ((String)object).equals(object2) ? 1 : 0;
                if (n12 == 0) continue;
            ...
            if (n12 == n11) {
                f12 = this.mMaxHeight;
                this.mMaxHeight = f11 = xmlPullParser.getDimension(n12, f12);
                continue;
            }
            n11 = R$styleable.Variant_region_heightMoreThan;
            if (n12 == n11) {
                f12 = this.mMinHeight;
                this.mMinHeight = f11 = xmlPullParser.getDimension(n12, f12);
                continue;
            }
            n11 = R$styleable.Variant_region_widthLessThan;
            if (n12 == n11) {
                f12 = this.mMaxWidth;
                this.mMaxWidth = f11 = xmlPullParser.getDimension(n12, f12);
                continue;
            }
            n11 = R$styleable.Variant_region_widthMoreThan;
            if (n12 == n11) {
                f12 = this.mMinWidth;
                this.mMinWidth = f11 = xmlPullParser.getDimension(n12, f12);
                continue;
            }
