...
import androidx.constraintlayout.utils.widget.ImageFilterButton$1;
import androidx.constraintlayout.utils.widget.ImageFilterButton$2;
...
extends AppCompatImageButton {
    ...
    public ImageFilterButton(Context context, AttributeSet attributeSet, int n10) {
        ...
        if (attributeSet != null) {
            ...
            for (int i10 = 0; i10 < n11; ++i10) {
                ...
                if (n14 == (n13 = R$styleable.ImageFilterView_crossfade)) {
                    this.mCrossfade = f11 = attributeSet.getFloat(n14, 0.0f);
                    continue;
                }
                n13 = R$styleable.ImageFilterView_warmth;
                if (n14 == n13) {
                    f11 = attributeSet.getFloat(n14, 0.0f);
                    this.setWarmth(f11);
                    continue;
                }
                ...
                if (n14 == n13) {
                    f11 = attributeSet.getFloat(n14, 0.0f);
                    this.setSaturation(f11);
                    continue;
                }
                n13 = R$styleable.ImageFilterView_contrast;
                if (n14 == n13) {
                    f11 = attributeSet.getFloat(n14, 0.0f);
                    this.setContrast(f11);
                    continue;
                }
                ...
                if (n14 == n13) {
                    if (n10 < n15) continue;
                    f11 = attributeSet.getDimension(n14, 0.0f);
                    this.setRound(f11);
                    continue;
                }
    ...
    public void setBrightness(float f10) {
        ...
        imageFilterView$ImageMatrix.updateMatrix((ImageView)this);
    }
    ...
    public void setRound(float f10) {
        ...
        if (f15 != false) {
            ...
            if (n10 >= n11) {
                ...
                if (object == null) {
                    object = new ImageFilterButton$2(this);
    ...
    public void setRoundPercent(float f10) {
        ...
        if (f16 != false) {
            ...
            if (n10 >= n13) {
                object = this.mViewOutlineProvider;
                if (object == null) {
                    object = new ImageFilterButton$1(this);
                    this.mViewOutlineProvider = object;
                    this.setOutlineProvider((ViewOutlineProvider)object);
                }
