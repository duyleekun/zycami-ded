...
TintableImageSourceView {
    ...
    public AppCompatImageView(Context object, AttributeSet attributeSet, int n10) {
        ...
        this.mImageHelper = object = new AppCompatImageHelper(this);
    ...
    public void setImageResource(int n10) {
        ...
        if (appCompatImageHelper != null) {
            appCompatImageHelper.setImageResource(n10);
        }
    }
