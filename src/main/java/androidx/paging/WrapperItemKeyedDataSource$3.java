...
public class WrapperItemKeyedDataSource$3
extends ItemKeyedDataSource$LoadCallback {
    ...
    public WrapperItemKeyedDataSource$3(WrapperItemKeyedDataSource wrapperItemKeyedDataSource, ItemKeyedDataSource$LoadCallback itemKeyedDataSource$LoadCallback) {
