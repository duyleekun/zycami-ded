...
public class WrapperPageKeyedDataSource$2
extends PageKeyedDataSource$LoadCallback {
    ...
    public WrapperPageKeyedDataSource$2(WrapperPageKeyedDataSource wrapperPageKeyedDataSource, PageKeyedDataSource$LoadCallback pageKeyedDataSource$LoadCallback) {
