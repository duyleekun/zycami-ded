...
public class ContiguousPagedList$3
implements Runnable {
    public final /* synthetic */ ContiguousPagedList this$0;
    public final /* synthetic */ Object val$item;
    public final /* synthetic */ int val$position;

    public ContiguousPagedList$3(ContiguousPagedList contiguousPagedList, int n10, Object object) {
    ...
    public void run() {
        ...
        if (bl2) {
            ...
            PageResult$Receiver pageResult$Receiver = ((ContiguousPagedList)object).mReceiver;
            contiguousDataSource.dispatchLoadAfter(n10, object2, n11, executor, pageResult$Receiver);
        }
    }
}
