...
public final class R$styleable {
    ...
    static {
        int[] nArray;
        int[] nArray2;
        int[] nArray3 = nArray2 = new int[5];
        int[] nArray4 = nArray2;
        nArray3[0] = 0x1010003;
        nArray4[1] = 2130968576;
        nArray3[2] = 2130968820;
        nArray4[3] = 2130968821;
        nArray4[4] = 2130969394;
        ActivityNavigator = nArray2;
        ...
        int[] nArray10 = nArray2 = new int[12];
        ...
        int[] nArray13 = nArray12 = new int[9];
        int[] nArray14 = nArray12;
        nArray13[0] = 0x10100D0;
        nArray14[1] = 2130968832;
        nArray13[2] = 2130968867;
        nArray14[3] = 2130968870;
        nArray13[4] = 2130969003;
        nArray14[5] = 2130969202;
        nArray13[6] = 2130969203;
        nArray14[7] = 2130969204;
        nArray14[8] = 2130969205;
        NavAction = nArray12;
        int n11 = 4;
        int[] nArray15 = nArray = new int[n11];
        int[] nArray16 = nArray;
        nArray15[0] = 0x1010003;
        nArray16[1] = 16843245;
        nArray15[2] = 2130968627;
        nArray16[3] = 2130969165;
        NavArgument = nArray;
        int[] nArray17 = nArray12 = new int[n11];
        int[] nArray18 = nArray12;
        nArray17[0] = 16844014;
        nArray18[1] = 2130968576;
        nArray17[2] = 2130969139;
        nArray18[3] = 2130969492;
        NavDeepLink = nArray12;
        n11 = 1;
        nArray = new int[n11];
        nArray[0] = 2130969334;
        NavGraphNavigator = nArray;
        nArray = new int[n11];
        nArray[0] = 2130969158;
        NavHost = nArray;
        nArray12 = new int[n11];
        nArray12[0] = 2130968939;
        NavInclude = nArray12;
        nArray2 = new int[n10];
        nArray2[0] = 0x1010001;
        nArray2[1] = 0x10100D0;
