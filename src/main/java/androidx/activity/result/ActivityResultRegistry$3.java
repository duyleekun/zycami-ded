...
public class ActivityResultRegistry$3
extends ActivityResultLauncher {
    ...
    public ActivityResultRegistry$3(ActivityResultRegistry activityResultRegistry, String string2, int n10, ActivityResultContract activityResultContract) {
